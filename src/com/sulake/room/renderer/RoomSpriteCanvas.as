package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_223:Sprite;
      
      private var var_116:Sprite;
      
      private var var_51:Sprite;
      
      private var var_534:Map;
      
      private var var_431:Point;
      
      private var var_224:BitmapDataCache;
      
      private var var_537:RoomObjectCache;
      
      private var var_432:Array;
      
      private var var_538:Array;
      
      private var var_1244:IRoomRenderingCanvasMouseListener = null;
      
      private var _id:String = "";
      
      private var var_300:Map = null;
      ...
      private var var_2057:Number = -1.0E7;
      
      private var var_2056:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_223 = new Sprite();
         this.var_223.mouseEnabled = false;
         this.var_51 = new Sprite();
         this.var_51.name = "canvas";
         this.var_51.mouseEnabled = false;
         this.var_223.addChild(this.var_51);
         ...
         this.var_224 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_537 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_431.x -= param1 - this.var_535;
         this.var_535 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_431.y -= param1 - this.var_536;
         this.var_536 = param1;
      }
      ...
      {
         if(param1 && !this.var_811)
         {
            this.var_811 = true;
            if(this.var_116 != null && !this.var_223.contains(this.var_116))
            {
               this.var_223.addChild(this.var_116);
               this.var_51.mask = this.var_116;
            }
         }
         else if(!param1 && this.var_811)
         {
            this.var_811 = false;
            if(this.var_116 != null && this.var_223.contains(this.var_116))
            {
               this.var_223.removeChild(this.var_116);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_223.numChildren > 0)
            {
               this.var_223.removeChildAt(0);
            }
            this.var_223 = null;
         }
         this.var_51 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_538.length)
            {
               this.cleanSprite(this.var_538[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_538 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_116 != null)
         {
            this.var_116.graphics.clear();
         }
         else
         {
            this.var_116 = new Sprite();
            this.var_116.name = "mask";
            if(this.var_811)
            {
               this.var_223.addChild(this.var_116);
               this.var_51.mask = this.var_116;
         ...
         this.var_116.graphics.beginFill(0);
         this.var_116.graphics.drawRect(0,0,param1,param2);
         this.var_651 = param1;
         this._ht = param2;
      }
      ...
      {
         this.var_537.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_651 != this.var_2059 || this._ht != this.var_2060)
         {
            _loc9_ = true;
         }
         if(this.var_51.x != this.var_535 || this.var_51.y != this.var_536)
         {
            this.var_51.x = this.var_535;
            this.var_51.y = this.var_536;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_432.sortOn("z",0 | 0);
         if(_loc5_ < this.var_432.length)
         {
            this.var_432.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_432[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2059 = this.var_651;
         this.var_2060 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_537.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_537.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_535;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_536;
                  if(_loc19_ < this.var_651 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_432.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_535;
                     _loc17_.y = _loc20_ - this.var_536;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_538.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_652 || this.var_652 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_432.length)
         {
            return null;
         }
         return this.var_432[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_224.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_224.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_224.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_224.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_535;
         param2 -= this.var_536;
         this.var_431.x = param1;
         this.var_431.y = param2;
         if(this.var_981 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1523;
         }
         this.var_1523 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_981;
         return this.var_1523;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_651 / 2;
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_534.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_534.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2057 || param2 != this.var_2056)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_534.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_534.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         this.var_2056 = param2;
         return _loc8_;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(this.var_300 != null && param1 != null)
         {
            this.var_300.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_300 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_300.length)
         {
            _loc2_ = this.var_300.getKey(_loc1_);
            _loc3_ = this.var_300.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1244.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_981 == 0)
         {
            this.checkMouseHits(this.var_431.x,this.var_431.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_981 = 0;
         ++this.var_1524;
      }
