package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1416:int = 128;
      
      private var var_1417:Boolean = false;
      
      private var var_2679:Point;
      ...
      {
         if(param1 != this.var_1846 || param2 != this.var_1845)
         {
      ...
      {
         if(this.var_1416 > 255 || bitmapData == null)
         {
            return false;
         }
