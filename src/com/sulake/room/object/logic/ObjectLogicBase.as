package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_294:IRoomObjectController;
      ...
      {
         if(this.var_294 == param1)
         {
            return;
         }
         if(this.var_294 != null)
         {
            this.var_294.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_294 = param1;
            this.var_294.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_294 != null)
            {
               this.var_294.setLocation(param1.loc);
               this.var_294.setDirection(param1.dir);
            }
         }
      }
   }
