package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_294:IRoomObject;
      
      private var var_1194:IGraphicAssetCollection;
      
      protected var var_414:int = -1;
      
      protected var var_216:int = -1;
      
      protected var var_256:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_184.length > 0)
            {
               _loc1_ = this.var_184[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_184.length > param1)
         {
            _loc2_ = this.var_184[this.var_184.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_184.length)
         {
