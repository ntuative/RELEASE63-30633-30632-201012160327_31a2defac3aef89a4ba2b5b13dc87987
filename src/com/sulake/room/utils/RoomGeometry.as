package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_697:Number = 64;
      
      public static const const_1079:Number = 32;
      ...
      private var var_368:Number = 1.0;
      
      private var var_369:Number = 1.0;
      
      private var var_370:Number = 1.0;
      
      private var var_1640:Number = 1.0;
      
      private var var_1638:Number = 1.0;
      
      private var var_1639:Number = 1.0;
      
      private var var_72:Vector3d;
      
      private var var_233:Vector3d;
      
      private var var_2663:Number = -500.0;
      
      private var var_2664:Number = 500.0;
      
      private var _width:Number;
      
      private var var_451:Map = null;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1044 = new Vector3d();
         this.var_1640 = 1;
         this.var_1638 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1639 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_159.x,this.var_159.y,this.var_159.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_72.x * this.var_368,this.var_72.y * this.var_369,this.var_72.z * this.var_370);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_233.x,this.var_233.y,this.var_233.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_368 != param1 * this.var_1640)
         {
            this.var_368 = param1 * this.var_1640;
            ++this.var_142;
         }
      }
      ...
      {
         if(this.var_369 != param1 * this.var_1638)
         {
            this.var_369 = param1 * this.var_1638;
            ++this.var_142;
         }
      }
      ...
      {
         if(this.var_370 != param1 * this.var_1639)
         {
            this.var_370 = param1 * this.var_1639;
            ++this.var_142;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_72.x /= this.var_368;
         this.var_72.y /= this.var_369;
         this.var_72.z /= this.var_370;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_233.x;
         var _loc3_:Number = this.var_233.y;
         var _loc4_:Number = this.var_233.z;
         this.var_233.assign(param1);
         if(this.var_233.x != _loc2_ || this.var_233.y != _loc3_ || this.var_233.z != _loc4_)
         {
            ++this.var_142;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_451 != null)
         {
            ...
            this.var_451.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_451.add(_loc3_,_loc4_);
            ++this.var_142;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_451 != null)
         {
            ...
            return this.var_451.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1044.assign(_loc22_);
         }
         else
         {
            this.var_1044.assign(_loc17_);
         }
         ++this.var_142;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_368;
         _loc2_.y *= this.var_369;
         _loc2_.z *= this.var_370;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1044);
         if(_loc3_ < this.var_2663 || _loc3_ > this.var_2664)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_369;
            _loc2_.z *= this.var_370;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1044);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_72.x * this.var_368,this.var_72.y * this.var_369,this.var_72.z * this.var_370);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_159;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_368,param2.y * this.var_369,param2.z * this.var_370);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_368,param3.y * this.var_369,param3.z * this.var_370);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_368,param4.y * this.var_369,param4.z * this.var_370);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1079;
         }
         else
         {
            this.scale = const_697;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_697;
      }
