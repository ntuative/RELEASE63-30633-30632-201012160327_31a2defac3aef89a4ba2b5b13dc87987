package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1927:IWindowContainer;
      ...
      {
         this.var_1927 = IWindowContainer(this.var_44.getXmlWindow("roomvisits_row"));
         this.var_458 = new Timer(300,1);
         this.var_458.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
         this.var_44.messageHandler.addRoomVisitsListener(this);
         this.var_44.connection.send(new GetRoomVisitsMessageComposer(this._userId));
         this._frame = IFrameWindow(this.var_44.getXmlWindow("roomvisits_frame"));
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         this.var_44.messageHandler.removeRoomVisitsListener(this);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1300;
      }
      ...
      private function populate() : void
      {
         var _loc2_:* = null;
         var _loc1_:* = true;
         for each(_loc2_ in this.var_108)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_1927.clone());
         ...
         new OpenRoomTool(this._frame,this.var_44,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(this.var_44,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
