package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1001:int = 3;
      
      public static const const_625:int = 4;
      
      public static const const_926:int = 5;
      
      public static const const_1300:int = 6;
      
      public static const const_1488:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1437:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1733[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1733[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
