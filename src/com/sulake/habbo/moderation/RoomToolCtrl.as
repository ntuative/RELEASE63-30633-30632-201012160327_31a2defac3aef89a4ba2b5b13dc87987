package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_818:ICheckBoxWindow;
      
      private var var_1281:ICheckBoxWindow;
      
      private var var_1282:ICheckBoxWindow;
      ...
      {
         this._frame = IFrameWindow(this.var_44.getXmlWindow("roomtool_frame"));
         this.var_44.messageHandler.addRoomInfoListener(this);
         this.var_44.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_340));
         Logger.log("BEGINNING TO SHOW: " + this.var_340);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1437;
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_44.messageHandler.removeRoomEnterListener(this);
         if(this._frame != null)
         {
            this._frame.destroy();
            this._frame = null;
      ...
      {
         var _loc2_:Boolean = this._data != null && this._data.flatId == this.var_44.currentFlatId;
         var _loc3_:IButtonWindow = IButtonWindow(this._frame.findChildByName(param1));
         if(_loc2_ && this.var_44.initMsg.roomAlertPermission)
         {
            _loc3_.enable();
         }
         else
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_340);
         if(param1.flatId != this.var_340)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_340);
            return;
         }
         this._data = param1;
         this.populate();
         this.var_44.messageHandler.removeRoomInfoListener(this);
         this._frame.visible = true;
         this.var_44.messageHandler.addRoomEnterListener(this);
      ...
      public function populate() : void
      {
         ...
         this.var_818 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1281 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1282 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
         ...
         this.var_44.disableButton(this.var_44.initMsg.chatlogsPermission,this._frame,"chatlog_but");
         if(!this.var_44.initMsg.roomKickPermission)
         {
            this.var_818.disable();
         }
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = IWindowContainer(this.var_44.getXmlWindow("roomtool_roomdata"));
            _loc3_.addChild(_loc4_);
         }
         if(!param1.exists)
         {
            this.var_53.removeListItem(_loc3_);
            this.var_53.removeListItem(this.var_53.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new UserInfoFrameCtrl(this.var_44,this._data.ownerId),this._frame,false,false,true);
      }
      ...
      private function onEnterRoom(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.goToRoom(this._data.flatId);
      }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_44,WindowTracker.const_625,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function onEditInHk(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.openHkPage("roomadmin.url","" + this._data.flatId);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_818.isSelected);
         this.var_44.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1397,_loc2_,this.var_480.text,"",""));
         if(this.var_1281.isSelected || this.var_1282.isSelected || this.var_818.isSelected)
         {
            this.var_44.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1281.isSelected,this.var_1282.isSelected,this.var_818.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1331);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1276);
      }
      ...
      {
         Logger.log("MSG TEMPLATES: " + this.var_44.initMsg.roomMessageTemplates.length);
         param1.populate(this.var_44.initMsg.roomMessageTemplates);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_44.initMsg.roomMessageTemplates[this.var_940.selection];
         if(_loc3_ != null)
         {
            this.var_551 = false;
