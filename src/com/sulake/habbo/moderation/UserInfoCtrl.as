package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_867:int = 60;
      
      private static const const_866:int = 3600;
      
      private static const const_865:int = 86400;
      
      private static const const_868:int = 31536000;
      ...
      {
         if(param1 < 2 * const_867)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_866)
         {
            return Math.round(param1 / const_867) + " mins ago";
         }
         if(param1 < 2 * const_865)
         {
            return Math.round(param1 / const_866) + " hours ago";
         }
         if(param1 < 2 * const_868)
         {
            return Math.round(param1 / const_865) + " days ago";
         }
         return Math.round(param1 / const_868) + " years ago";
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         this._data = null;
         this.refresh();
         this.var_44.messageHandler.addUserInfoListener(this);
         this.var_44.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         this._disposed = true;
         this.var_44.messageHandler.removeUserInfoListener(this);
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1074.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_44.getXmlWindow("user_info"));
            this.var_1074.addChild(_loc1_);
            this.var_44.disableButton(this.var_44.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            this.var_44.disableButton(this.var_44.initMsg.alertPermission,_loc1_,"message_but");
            this.var_44.disableButton(this.var_44.initMsg.alertPermission || this.var_44.initMsg.kickPermission || this.var_44.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_44,WindowTracker.const_926,this._data.userId),this._callerFrame,this.var_1075,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new RoomVisitsCtrl(this.var_44,this._data.userId),this._callerFrame,this.var_1075,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.openHkPage("habboinfotool.url",this._data.userName);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new SendMsgsCtrl(this.var_44,this._data.userId,this._data.userName,this.var_1383),this._callerFrame,this.var_1075,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ModActionCtrl(this.var_44,this._data.userId,this._data.userName,this.var_1383),this._callerFrame,this.var_1075,false,true);
      }
      ...
      {
         this.var_44.openHkPage("moderatoractionlog.url",this._data.userName);
      }
   }
}
