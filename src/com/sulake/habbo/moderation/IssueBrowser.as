package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1855:String = "my_issues";
      
      private const const_1854:String = "open_issues";
      
      private const const_1856:String = "picked_issues";
      
      private const const_1861:String = "closed_issues";
      ...
      private var var_341:IIssueBrowserView;
      
      private var var_1829:IIssueBrowserView;
      
      private var var_1828:IIssueBrowserView;
      
      private var var_1827:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_341 == _loc2_)
         {
            return;
         }
         if(this.var_341 != null)
         {
            this.var_341.visible = false;
         }
         this.var_341 = _loc2_;
         if(this.var_341 == null)
         {
         ...
         this.var_341.view.width = this.var_246.container.width;
         this.var_341.view.height = this.var_246.container.height;
         this.var_341.visible = true;
         this.var_341.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1855:
               if(this.var_1829 == null)
               {
                  this.var_1829 = new MyIssuesView(this.issueManager,this,this.var_246.container);
               }
               return this.var_1829;
            case this.const_1854:
               if(this.var_1828 == null)
               {
                  this.var_1828 = new OpenIssuesView(this.issueManager,this,this.var_246.container);
               }
               return this.var_1828;
            case this.const_1856:
               if(this.var_1827 == null)
               {
                  this.var_1827 = new PickedIssuesView(this.issueManager,this,this.var_246.container);
               }
