package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_89.roomEngine.getRoomObject(this.var_89.roomId,this.var_89.roomCategory,param1,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
      }
