package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_1585:int = 0;
      ...
      private static const const_559:String = "wall_place_holder";
      
      private static const const_1250:String = const_393;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_880:String = "tile_cursor";
      
      private static const const_882:String = "selection_arrow";
      ...
      private var var_735:Map = null;
      
      private var var_398:Map = null;
      
      private var var_454:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1395:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         this.var_604 = [];
         this._wallItems = [];
         this.var_2524 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2520 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_881)
         {
            return;
         }
         this.var_1395 = param1;
         this.var_2519 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2522 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2521 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2518 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_881;
         this.initFurniData();
      }
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = this.var_356.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_398.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_398.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_734.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_605.add(_loc3_,_loc4_);
               if(this.var_604.indexOf(_loc7_) < 0)
               {
                  this.var_604.push(_loc7_);
               }
            }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2523)
         {
            ...
            {
               this.var_1395.dispatchEvent(new Event(const_769));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_486 != null)
         {
            this.var_486.remove(param2);
            this.var_486.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_486 != null)
         {
            _loc2_ = this.var_486.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_604.indexOf(param1) >= 0)
         {
      ...
      {
         return [const_393,const_559,ROOM_CONTENT,const_880,const_882];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_605.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_734.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_181 != null && this.var_181.hasWorldType(const_312 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_168 || param1 == RoomObjectVisualizationEnum.const_61 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2518;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2521 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_604.indexOf(_loc4_) == -1)
                     {
                        this.var_604.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_343,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1396.getValue(param1) != null)
         {
            this.var_181 = this.var_1396.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_654,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2524.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2520.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1396.add(_loc5_,_loc8_);
               this.var_181 = _loc8_;
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_420,_loc5_);
         }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_735.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_735.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_735.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_198 && _loc5_ != RoomObjectLogicEnum.const_168)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_454.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_398.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_398.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_398[_loc2_] != null)
         {
            _loc3_ = this.var_398.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_312 + param1) == RoomObjectCategoryEnum.const_74)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_181.getWorldHeightScale(const_312 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_181 != null)
         {
            return this.var_181.getWorldScale(const_312 + param1);
         }
         return 32;
      }
