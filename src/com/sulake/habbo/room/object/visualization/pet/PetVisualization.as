package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_549:PetVisualizationData = null;
      ...
      private const const_1177:int = 3;
      ...
      {
         this.var_549 = param1 as PetVisualizationData;
         createSprites(this.const_1177);
         this.var_361 = new ExperienceData(this.var_549);
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1554 = param1.getNumber(RoomObjectVariableEnum.const_463) > 0;
            this.var_1257 = param1.getString(RoomObjectVariableEnum.const_286);
            this.var_227 = param1.getString(RoomObjectVariableEnum.const_476);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_682);
            this.var_1549 = param1.getNumber(RoomObjectVariableEnum.const_365);
            this.var_1264 = param1.getNumber(RoomObjectVariableEnum.const_1025);
            this.var_2010 = param1.getNumber(RoomObjectVariableEnum.const_1055);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_159);
            if(this.var_584 != _loc3_)
            {
               this.var_584 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_414 != param1.getUpdateID() || this.var_1467 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1549;
            if(isNaN(this.var_1549))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_1550 || param3)
            {
               this.var_1550 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_52.setDirectionAngle(AvatarSetType.const_32,_loc4_);
            }
            if(_loc5_ != this.var_1553 || param3)
            {
               this.var_1553 = _loc5_;
               _loc5_ -= 112.5;
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_549.getAvatar(this.var_584,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_548 = null;
         _loc2_ = getSprite(this.const_1558);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc9_ || _loc6_ != var_256 || this.var_52 == null)
         {
            if(_loc6_ != var_256)
            {
               var_256 = _loc6_;
         ...
         var _loc11_:Boolean = this.var_840 || this.var_1015 > 0 || this.var_1585;
         this.var_361.alpha = 0;
         if(this.var_1264 > 0)
         {
            _loc12_ = param2 - this.var_1264;
            if(_loc12_ < AvatarAction.const_933)
            {
               this.var_361.alpha = int(Math.sin(_loc12_ / 0 * 0) * 255);
               this.var_361.setExperience(this.var_2010);
               this.var_1015 = this.const_1830;
            }
            else
            {
               this.var_1264 = 0;
            }
            _loc13_ = getSprite(this.const_1555);
            if(_loc13_ != null)
            {
         ...
         if(_loc10_ || _loc11_)
         {
            ...
            _loc13_ = getSprite(this.const_845);
            if(_loc13_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         {
            param1.appendAction(AvatarAction.const_298,this.var_1257);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1177;
