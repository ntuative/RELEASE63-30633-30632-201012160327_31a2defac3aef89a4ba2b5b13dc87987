package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1478:int = 16777215;
      
      public static const const_1405:int = 13421772;
      
      private static const const_862:int = 16777215;
      
      private static const const_861:int = 13421772;
      
      private static const const_863:int = 10066329;
      
      private static const const_864:int = 10066329;
      
      public static const const_1360:int = 16777215;
      
      public static const const_1294:int = 13421772;
      
      public static const const_1269:int = 10066329;
      ...
      private var var_695:Rectangle = null;
      
      private var var_457:RoomPlaneBitmapMaskParser = null;
      
      private var var_1649:String = null;
      
      private var _floorType:String = null;
      
      private var var_1650:String = null;
      
      private var var_2361:String = null;
      
      private var var_1068:uint = 16777215;
      
      private var var_2357:int = 255;
      
      private var var_2359:int = 255;
      
      private var var_2358:int = 255;
      ...
      private const const_1841:int = 250;
      
      private var var_1467:int = -1;
      
      private var var_1199:Number = 0.0;
      
      private var var_1956:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_457 = new RoomPlaneBitmapMaskParser();
         this.var_277["null"] = false;
         this.var_277["null"] = true;
         this.var_277["null"] = true;
         this.var_277["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_695 = super.boundingRectangle;
         }
         return new Rectangle(this.var_695.x,this.var_695.y,this.var_695.width,this.var_695.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_106 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_918);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_942);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_141)
            {
               ...
               {
                  _loc13_.color = const_864;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_862;
               }
               else if(_loc14_.y == 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_288)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1379)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_106,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_288)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1841 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_322.length)
            {
               _loc10_ = this.var_576[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_322[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_91)
               {
                  if(this.var_1686)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2358 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2359 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2357 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1467)
         {
            this.var_1467 = param1.updateId;
            this.var_695 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1199 || _loc3_.y != this.var_1956 || _loc3_.z != this.var_1960 || param1.scale != this.var_1957))
            {
               this.var_1199 = _loc3_.x;
               this.var_1956 = _loc3_.y;
               this.var_1960 = _loc3_.z;
               this.var_1957 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1118);
            if(_loc3_ != this.var_2361)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2361 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_815));
            if(_loc4_ != this.var_1068)
            {
               this.var_1068 = _loc4_;
               this.var_2358 = this.var_1068 & 255;
               this.var_2359 = this.var_1068 >> 8 & 255;
               this.var_2357 = this.var_1068 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1021));
            if(_loc5_ != this.var_1686)
            {
               this.var_1686 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_734);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_780);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_603);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_608));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_630));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_813));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_125.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_106 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_277["null"] || param2 != this.var_277["null"] || param3 != this.var_277["null"])
         {
            this.var_277["null"] = param1;
            this.var_277["null"] = param2;
            this.var_277["null"] = param3;
            this.var_322 = [];
            this.var_576 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_322;
         if(this.var_322.length == 0)
         {
            _loc6_ = this.var_125;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_322.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_277[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_322.push(_loc12_);
                        this.var_576.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1687;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_457.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_457.maskCount)
         {
            _loc10_ = this.var_457.getMaskType(_loc8_);
            _loc11_ = this.var_457.getMaskLocation(_loc8_);
            _loc12_ = this.var_457.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_125.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_106 || _loc3_.type == RoomPlane.const_91)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_106 || _loc3_.type == RoomPlane.const_91 && _loc12_ == RoomPlaneBitmapMaskData.const_221)
                              {
