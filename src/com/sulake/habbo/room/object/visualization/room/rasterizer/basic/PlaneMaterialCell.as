package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_30:BitmapData = null;
      
      private var var_562:PlaneTexture;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_562 != null)
         {
            _loc2_ = this.var_562.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_562 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  if(this.var_30 != null)
                  {
                     if(this.var_30.width != _loc2_.width || this.var_30.height != _loc2_.height)
                     {
                        this.var_30.dispose();
                        this.var_30 = null;
                     }
                     ...
                     {
                        this.var_30.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(this.var_30 == null)
                  {
                     this.var_30 = _loc2_.clone();
                  }
                  _loc3_ = Math.min(this.var_1037,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1037,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1037,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     ...
                     if(_loc7_ != null && _loc8_ != null)
                     {
                        ...
                        if(_loc9_ != null)
                        {
                           ...
                           if(_loc10_ != null)
                           {
                              ...
                              this.var_30.draw(_loc10_,_loc12_);
                           }
                        }
                     }
                     _loc6_++;
