package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1194:IGraphicAssetCollection;
      
      private var var_1768:XMLList;
      ...
      private var var_1125:Point = null;
      
      private var var_1393:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_908)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1393 = this.var_37.getValue(this.var_908);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2512 = new Vector3d(-0.5,0.5,0);
         this.var_909 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2512);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1125.x = _loc3_.x;
         this.var_1125.y = _loc3_.y;
      }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1789 = RoomObjectVariableEnum.const_916;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1789 = RoomObjectVariableEnum.const_907;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1126 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1126 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         if(param2 == this.var_2514 && param3 == this.var_2513)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1126 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1126 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1789);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_481;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1393.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1194.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1125.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1125.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_396.indexOf(_loc10_) >= 0 && this.var_909)
            {
               param1 = this.var_396.indexOf(_loc10_);
               if(this.var_602[param1] != "")
               {
                  _loc9_ = this.var_1194.getAsset(this.var_602[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_601[param1] != -1)
               {
                  param2.alpha = this.var_601[param1];
               }
               this.var_396.splice(param1,1);
               this.var_602.splice(param1,1);
               this.var_601.splice(param1,1);
      ...
      {
         this.var_909 = true;
         var _loc3_:int = this.var_396.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_396.push(param1);
            this.var_602.push(param2);
            this.var_601.push(-1);
         }
         else
         {
            this.var_602[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_396.push(param1);
            this.var_602.push("");
            this.var_601.push(param2);
         }
         else
         {
            this.var_601[_loc3_] = param2;
         }
      }
   }
}
