package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1262:int = const_366;
      ...
      public static const const_266:int = const_110;
      ...
      private var var_1726:Boolean = true;
      
      private var var_2271:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2272:Number = -1.0;
      
      private var var_2273:Number = 1.0;
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_653,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_586,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1727 == const_110)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_586);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_586,this.var_30.width,this.var_586);
         }
