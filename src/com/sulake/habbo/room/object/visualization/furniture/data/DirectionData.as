package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class DirectionData
   {
      ...
      {
         return this.var_105.length;
      }
      
      private function method_1(param1:int) : LayerData
      {
         if(param1 < 0 || param1 >= this.layerCount)
         {
            return null;
         }
         return this.var_105[param1];
      }
      
      public function getTag(param1:int) : String
      {
         var _loc2_:LayerData = this.method_1(param1);
         if(_loc2_ != null)
         {
            return _loc2_.tag;
         }
      ...
      {
         var _loc3_:LayerData = this.method_1(param1);
         if(_loc3_ != null)
         {
            _loc3_.tag = param2;
         }
      ...
      public function copyValues(param1:DirectionData) : void
      {
         ...
         {
            _loc2_ = this.method_1(_loc4_);
            _loc3_ = param1.method_1(_loc4_);
            if(_loc2_)
            {
