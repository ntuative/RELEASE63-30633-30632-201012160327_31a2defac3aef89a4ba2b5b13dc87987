package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_261.assign(param2);
         this.var_260 = new Vector3d();
         this.var_260.assign(param3);
         this.var_636 = new Vector3d();
         this.var_636.assign(param2);
         this.var_637 = new Vector3d();
         this.var_637.assign(param3);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_173 != null)
         {
            ...
            {
               _loc2_ = this.var_173.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         if(param1 != this.var_1958)
         {
            if(!param1)
            {
               this.var_261.assign(this.var_636);
               this.var_260.assign(this.var_637);
            }
            else
            {
               this.var_261.assign(this.var_636);
               this.var_261.mul(this.var_637.length / this.var_636.length);
               this.var_260.assign(this.var_637);
               this.var_260.mul(this.var_636.length / this.var_637.length);
            }
            this.var_1467 = -1;
      ...
      {
         var _loc3_:BitmapData = this.var_173.remove(param1) as BitmapData;
      ...
      private function needsNewTexture(param1:IRoomGeometry) : Boolean
      {
         ...
         var _loc3_:BitmapData = this.var_173.getValue(_loc2_) as BitmapData;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_261.length * param1.scale);
            _loc6_ = Number(this.var_260.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
            ...
            _loc4_ = this.var_173.getValue(_loc3_) as BitmapData;
            if(_loc4_ == null)
            {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_72 == null && this.var_962 != null || this.var_261 == null || this.var_260 == null || this.var_521 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1467)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1199 || _loc4_.y != this.var_1956 || _loc4_.z != this.var_1960 || param1.scale != this.var_1957))
            {
               this.var_1199 = _loc4_.x;
               this.var_1956 = _loc4_.y;
               this.var_1960 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_962);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_134.z - _loc7_,this.var_101.z - _loc7_,this.var_81.z - _loc7_,this.var_100.z - _loc7_);
               this.var_1959 = _loc8_;
