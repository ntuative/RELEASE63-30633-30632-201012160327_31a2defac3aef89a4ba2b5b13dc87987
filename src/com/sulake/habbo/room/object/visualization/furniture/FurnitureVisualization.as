package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1541:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2632:Number = NaN;
      
      protected var var_2633:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1179:String = null;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1620 != spriteCount)
         {
            createSprites(this.var_1620);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param1 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,this.var_2633,param2);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1067:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_948:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_414 != _loc3_.getUpdateID() || param1 != var_256 || param2 != this.var_2632)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2633 = _loc3_.getNumber(RoomObjectVariableEnum.const_240);
            ...
            this.var_1179 = _loc3_.getString(RoomObjectVariableEnum.const_324);
            if(this.var_1179 == null || this.var_1179.indexOf("http") != 0)
            {
               this.var_1179 = null;
            }
      ...
      {
         if(this.var_2442 != param1 || this.var_2443 != param2)
         {
            this.var_872 = [];
            this.var_873 = [];
            this.var_709 = [];
            ...
            this.var_1620 = this._data.getLayerCount(param2) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param1 >= FurnitureVisualizationData.const_1116.length)
         {
            return "";
         }
         var _loc3_:String = this.var_872[param1];
         var _loc4_:Boolean = this.var_873[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param1 < spriteCount - 1)
            {
               _loc6_ = FurnitureVisualizationData.const_1116[param1];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_872[param1] = _loc3_;
            this.var_873[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_713[param1] != null && !this.var_1728)
         {
