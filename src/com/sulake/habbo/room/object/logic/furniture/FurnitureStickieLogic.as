package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      private function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            _loc1_ = object.getModel().getString(RoomObjectVariableEnum.const_94);
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_240,_loc3_ + 1);
         }
      }
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_490,_loc3_,_loc4_);
                  if(_loc5_ != null)
                  {
