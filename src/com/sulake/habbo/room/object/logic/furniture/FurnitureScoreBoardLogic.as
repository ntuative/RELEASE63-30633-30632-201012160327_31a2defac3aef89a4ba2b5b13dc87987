package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_874:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_720 != _loc2_)
         {
            ...
            if(_loc3_ * const_392 > const_874)
            {
               this.var_1096 = const_874 / _loc3_;
            }
            else
            {
               this.var_1096 = const_392;
            }
            this.var_1357 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_720 && param1 >= this.var_1357 + this.var_1096)
            {
               _loc3_ = param1 - this.var_1357;
               _loc4_ = _loc3_ / this.var_1096;
               _loc5_ = 1;
               if(this.var_720 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1357 = param1 - (_loc3_ - _loc4_ * this.var_1096);
            }
         }
      }
   }
