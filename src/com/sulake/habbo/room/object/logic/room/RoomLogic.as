package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1607:int = 255;
      
      private var var_1277:uint = 16777215;
      
      private var var_1608:int = 255;
      
      private var var_1030:uint = 16777215;
      
      private var var_1610:int = 255;
      
      private var var_1031:int = 0;
      
      private var var_1609:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_918,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_815,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_608,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_630,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_813,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1031)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1607;
            if(_loc2_ - this.var_1031 >= this.var_1609)
            {
               _loc3_ = this.var_1030;
               _loc4_ = this.var_1610;
               this.var_1031 = 0;
            }
            else
            {
               _loc7_ = this.var_1277 >> 16 & 255;
               _loc8_ = this.var_1277 >> 8 & 255;
               _loc9_ = this.var_1277 & 255;
               _loc10_ = this.var_1030 >> 16 & 255;
               _loc11_ = this.var_1030 >> 8 & 255;
               _loc12_ = this.var_1030 & 255;
               _loc13_ = (_loc2_ - this.var_1031) / this.var_1609;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1608 + (this.var_1610 - this.var_1608) * _loc13_;
               this._color = _loc3_;
               this.var_1607 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_815,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_793:
               param2.setString(RoomObjectVariableEnum.const_780,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_699:
               param2.setString(RoomObjectVariableEnum.const_734,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_735:
               param2.setString(RoomObjectVariableEnum.const_603,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_482:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_221)
               {
                  _loc5_ = "null";
               }
               this.var_457.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_642:
               _loc4_ = this.var_457.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_457.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1118,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1033:
               param2.setNumber(RoomObjectVariableEnum.const_608,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_935:
               param2.setNumber(RoomObjectVariableEnum.const_630,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_813,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1021,int(param1.bgOnly));
         this.var_1277 = this._color;
         this.var_1608 = this.var_1607;
         this.var_1030 = _loc3_;
         this.var_1610 = _loc4_;
         this.var_1031 = getTimer();
         this.var_1609 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_444,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1465,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1408,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1351,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_444,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_182)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_141 || _loc13_ == RoomPlaneData.const_288)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
