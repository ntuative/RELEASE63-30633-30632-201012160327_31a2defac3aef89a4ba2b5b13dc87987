package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_968:BitmapData = null;
      
      private var var_967:BitmapData = null;
      ...
      {
         this.var_285 = param2 as IHabboCommunicationManager;
         if(this.var_285 == null)
         {
            return;
         }
         this._connection = this.var_285.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1988 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_1989 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_1990 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1480 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_193 != null && this.var_193.running)
         {
            this.var_193.reset();
            return false;
         }
         if(this.var_966 == 0)
         {
            this.var_966 = getTimer();
            return false;
         }
         if(this.var_1480 > 0 && this.var_1482 >= this.var_1480)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_966;
         if(_loc1_ > this.var_1989)
         {
            ++this.var_1482;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1211 = _loc2_.imageUrl;
         this.var_1991 = _loc2_.clickUrl;
         this.var_966 = getTimer();
         if(this.var_1211 != "")
         {
            _loc3_ = this.var_1211;
            ...
            {
               this.var_193 = new Timer(this.var_1990,1);
               this.var_193.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_193.running)
            {
               this.var_193.reset();
            }
            this.var_193.start();
            _loc4_ = new URLRequest(this.var_1211);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_507,0,0,param1.bitmapData,this.var_1991));
            this.var_966 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_540));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1210 = _loc2_.imageUrl;
         this.var_1481 = _loc2_.clickUrl;
         if(this.var_1210 != "" && this.var_1481 != "")
         {
            _loc3_ = this.var_1210;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1210);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_530,0,0,_loc4_,this.var_1481,this.var_968,this.var_967));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_968 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_967 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
