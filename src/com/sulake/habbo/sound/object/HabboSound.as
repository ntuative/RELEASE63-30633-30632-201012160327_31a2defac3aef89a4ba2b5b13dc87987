package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      private var var_1119:Sound = null;
      ...
      public function HabboSound(param1:Sound)
      {
         ...
         this.var_1119.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_474 = 1;
         this.var_1384 = false;
      }
      ...
      {
         this.var_1384 = false;
         this._soundChannel = this.var_1119.play(0);
      ...
      {
         return this.var_1119.length;
      }
      
      public function get ready() : Boolean
      {
         return !this.var_1119.isBuffering;
      }
