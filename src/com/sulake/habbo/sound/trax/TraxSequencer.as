package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private static const const_1245:uint = 88200;
      
      private static const const_1244:uint = 88200;
      ...
      private var var_1376:Sound;
      
      private var _soundChannel:SoundChannel;
      
      private var var_1752:TraxData;
      ...
      {
         this.var_1751 = uint(const_258 / 44.1);
         super();
         this._events = param4;
         this.var_2045 = param1;
         this.var_474 = 1;
         this.var_1376 = new Sound();
         ...
         this._length = 0;
         this.var_1375 = false;
         this.var_97 = new Vector.<Number>(const_258,true);
      }
      ...
      public function play() : Boolean
      {
         ...
         this.var_1375 = false;
         this.var_1376.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = this.var_1376.play();
         return true;
      }
      ...
      public function stop() : Boolean
      {
         ...
         this.var_1376.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = null;
         return true;
      }
      ...
      {
         return Math.ceil(param1 / const_1245);
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         var _loc11_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1752.channels.length)
         {
            _loc2_ = new Map();
            _loc3_ = this.var_1752.channels[_loc1_] as TraxChannel;
            _loc4_ = 0;
            _loc5_ = 0;
            _loc6_ = 0;
      ...
      private function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         var _loc4_:* = [];
         var _loc5_:* = null;
         var _loc6_:int = this.var_724.length;
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc2_.push(this.var_724[_loc7_].getKeys());
            _loc12_ = 0;
            ...
            _loc13_ = this.var_724[_loc7_].getWithIndex(_loc12_);
         ...
         while(_loc7_ >= 0)
         {
            ...
            while(_loc18_ < _loc17_)
            {
               ...
               if(_loc18_ < _loc17_)
               {
                  if(_loc16_ < this.var_724[_loc7_].length - 1)
                  {
                     _loc21_ = this.var_724[_loc7_].getWithIndex(++_loc16_);
                     if(_loc21_.id == 0)
                     {
                        _loc5_ = null;
                     }
         ...
         this.var_210 += const_258;
         if(this._soundChannel != null)
         {
            this.var_1751 = param1.position / 44.1 - this._soundChannel.position;
         }
         if(this.var_210 > this._length + this.var_1751 * 44.1)
         {
            this.var_1375 = true;
      ...
      {
         this.stop();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.const_686,this.var_2045));
      }
   }
}
