package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1840:String = "type_sound_machine";
      
      private const const_1562:String = "type_jukebox";
      
      private var var_547:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_609,this.onSoundMachinePlayEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_610,this.onSoundMachineStopEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_604,this.onJukeboxInitEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_415,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_89)
            {
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_609,this.onSoundMachinePlayEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_610,this.onSoundMachineStopEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_604,this.onJukeboxInitEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_415,this.onDisposeEvent);
               this.var_89 = null;
            }
            if(this.var_372)
            {
      ...
      {
         this.startPlaying(this.const_1840);
      }
      ...
      {
         this.startPlaying(this.const_1562);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(this.var_74 == null || this.var_74.length == 0)
         {
         ...
         if(_loc2_ != null)
         {
            this.var_274 = _loc2_.id;
            this.playSong(this.var_274);
         }
      }
      
      public function checkSongPlayState(param1:int) : void
      {
         if(this.var_274 == param1)
         {
            this.playSong(this.var_274);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_372[this.var_274] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_372.getValue(this.var_274) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_274 = param1;
         var _loc2_:IHabboSound = this.var_372.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_547.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_547.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_274)
         {
            _loc6_ = this.var_372[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1655 == this.const_1562)
         {
            this.var_74.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function getNextEntry() : PlayListEntry
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_74.length)
         {
            _loc2_ = this.var_74[_loc3_];
            if(_loc2_.id == this.var_274)
            {
               _loc1_ = _loc3_ + 1;
            }
            _loc3_++;
         }
         if(_loc1_ >= this.var_74.length)
         {
            _loc1_ = 0;
         }
         return this.var_74[_loc1_];
      }
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_572.indexOf(param1) == -1)
         {
            this.var_572.push(param1);
         }
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_74.length)
            {
               _loc6_ = this.var_74[_loc5_] as PlayListEntry;
               if(_loc6_.id == _loc3_.id)
               {
                  this.var_74.splice(_loc5_,1);
                  _loc4_ = false;
                  break;
               }
               _loc5_++;
         ...
         this.var_572 = this.var_572.splice(this.var_572.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_372[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_547.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_372.add(_loc3_.id,_loc7_);
            }
      ...
      private function onPlayListSongAddedMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_74.push(_loc4_);
         if(this.var_74.length == 1)
         {
