package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      {
         return RoomWidgetEnum.const_358;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_386 != null)
         {
            ...
            {
               _loc2_ = this.var_386.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_385.length)
            {
               _loc2_ = this.var_385.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_652,RoomWidgetChatSelectAvatarMessage.const_816];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_652:
               if(this._container != null && this._container.roomSession != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     {
                        case RoomWidgetChatMessage.const_138:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_816:
      ...
      {
         return [RoomSessionChatEvent.const_187];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_187:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_226)
                           {
                              _loc13_ = this.var_385.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_386.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_889.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_226:
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_226)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_385.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_386.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_889.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_723 == null)
            {
               ...
               this.var_476.y = 0;
               this.var_476.z = 0;
               this.var_723 = _loc4_.getScreenPoint(this.var_476);
            ...
            this.var_476.y = 0;
            this.var_476.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_476);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_723.x || _loc8_.y != this.var_723.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_723,_loc5_));
