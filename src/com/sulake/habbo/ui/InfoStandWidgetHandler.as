package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_442;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_151,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_124,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_148,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_151,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_124,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_148,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_741.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_741.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_335);
         _loc1_.push(RoomWidgetUserActionMessage.const_703);
         _loc1_.push(RoomWidgetUserActionMessage.const_665);
         _loc1_.push(RoomWidgetUserActionMessage.const_708);
         _loc1_.push(RoomWidgetUserActionMessage.const_719);
         _loc1_.push(RoomWidgetUserActionMessage.const_809);
         _loc1_.push(RoomWidgetUserActionMessage.const_498);
         _loc1_.push(RoomWidgetUserActionMessage.const_643);
         _loc1_.push(RoomWidgetUserActionMessage.const_786);
         _loc1_.push(RoomWidgetUserActionMessage.const_647);
         _loc1_.push(RoomWidgetUserActionMessage.const_657);
         _loc1_.push(RoomWidgetUserActionMessage.const_752);
         _loc1_.push(RoomWidgetFurniActionMessage.const_260);
         _loc1_.push(RoomWidgetFurniActionMessage.const_775);
         _loc1_.push(RoomWidgetFurniActionMessage.const_675);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_563);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_774);
         _loc1_.push(RoomWidgetUserActionMessage.const_414);
         _loc1_.push(RoomWidgetUserActionMessage.const_739);
         _loc1_.push(RoomWidgetUserActionMessage.const_537);
         _loc1_.push(RoomWidgetUserActionMessage.const_1260);
         _loc1_.push(RoomWidgetPetCommandMessage.const_615);
         _loc1_.push(RoomWidgetPetCommandMessage.const_672);
         _loc1_.push(RoomWidgetUserActionMessage.const_533);
         _loc1_.push(RoomWidgetUserActionMessage.const_350);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_414)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_350 || param1.type == RoomWidgetUserActionMessage.const_533 || param1.type == RoomWidgetUserActionMessage.const_537)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_335:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_703:
            ...
            case RoomWidgetUserActionMessage.const_533:
               ...
               break;
            case RoomWidgetUserActionMessage.const_708:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_996,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_719:
            ...
            case RoomWidgetUserActionMessage.const_809:
               ...
               break;
            case RoomWidgetUserActionMessage.const_498:
               this._container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_643:
               this._container.roomSession.banUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_786:
               this._container.roomSession.assignRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_647:
            ...
            case RoomWidgetUserActionMessage.const_657:
               ...
               break;
            case RoomWidgetUserActionMessage.const_752:
            ...
            case RoomWidgetUserActionMessage.const_537:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_775:
            ...
            case RoomWidgetUserActionMessage.const_350:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_563:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_774:
               ...
               break;
            case RoomWidgetUserActionMessage.const_414:
               this._container.roomSession.kickBot(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_739:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_688);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_375);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_930);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1012);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_226)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_331)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1093)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_432);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_208)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_737);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1440;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_991;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_892;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1398);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = this._container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_46,_loc18_);
               if(_loc19_ != null)
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_123];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_123:
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_46,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_741.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_46);
            this.var_741.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_737);
