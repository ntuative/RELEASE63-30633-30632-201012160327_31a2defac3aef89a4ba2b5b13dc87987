package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_460;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_507);
         _loc1_.push(AdEvent.const_540);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_99);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_294);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_99:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_294:
               this._container.events.dispatchEvent(param1);
         }
      }
