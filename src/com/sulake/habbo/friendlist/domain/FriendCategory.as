package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_1115:int = 0;
      ...
      {
         if(this.var_907 >= this.getPageCount())
         {
            this.var_907 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_212.length / const_337);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_907 * const_337;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_907 + 1) * const_337,this.var_212.length);
      }
