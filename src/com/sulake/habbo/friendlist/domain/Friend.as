package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1695:int = "F".charCodeAt(0);
      
      public static const const_1769:int = "M".charCodeAt(0);
      ...
      private var var_1114:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_867 = param1.gender;
         this.var_707 = param1.online;
         this.var_1648 = param1.followingAllowed && param1.online;
         this.var_584 = param1.figure;
         this.var_1763 = param1.motto;
         this.var_1723 = param1.lastAccess;
         this.var_1377 = param1.categoryId;
         this.var_1724 = param1.realName;
