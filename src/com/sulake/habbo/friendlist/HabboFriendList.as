package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_155:String = "face";
      ...
      private var var_974:IAvatarRenderManager;
      
      private var var_646:ISessionDataManager;
      
      private var var_2028:FriendListLookAndFeel;
      
      private var var_359:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1504:OpenedToWebPopup;
      
      private var var_2029:int;
      
      var var_91:FriendCategories;
      
      private var var_295:FriendRequests;
      
      private var var_1505:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_877:IHabboNotifications;
      
      private var var_528:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2028 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1505 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_528.stop();
            this.var_528.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_528 = null;
         }
         ...
         if(this.var_974)
         {
            this.var_974.release(new IIDAvatarRenderManager());
            this.var_974 = null;
         }
         if(this.var_877)
         {
            this.var_877.release(new IIDHabboNotifications());
            this.var_877 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_646)
         {
            this.var_646.release(new IIDSessionDataManager());
            this.var_646 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1504 = new OpenedToWebPopup(this);
         }
         this.var_1504.show(x,y);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_88);
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_97,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_295.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_262,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_974.createAvatarImage(param1,AvatarScaleType.const_82,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_974 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_877 = param2 as IHabboNotifications;
      ...
      {
         this.var_646 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_295 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_1115,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_338,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_91.addFriend(new Friend(_loc4_));
         }
         this.var_359 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_528)
         {
            this.var_528 = new Timer(120000);
            this.var_528.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_528.start();
         }
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_338);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_359.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_356));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_88:
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_295.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_295.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_359.findTab(FriendListTab.const_87).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_295.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_359.findTab(FriendListTab.const_87);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1505.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_359.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_646 || !this.var_295)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_646.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_295.vipLimit;
         }
         else if(this.var_646.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_295.clubLimit;
         }
         if(_loc2_ > this.var_295.limit)
         {
            this.var_295.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_155) as IBitmapWrapperWindow;
