package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_357:String = "TUI_NAME_VIEW";
      ...
      private var var_301:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         this.var_44 = param1;
         this.var_44.events.addEventListener(HabboHelpTutorialEvent.const_496,this.onTaskDoneEvent);
         this.var_44.events.addEventListener(HabboHelpTutorialEvent.const_402,this.onTaskDoneEvent);
         this.var_44.events.addEventListener(HabboHelpTutorialEvent.const_472,this.onTaskDoneEvent);
      }
      ...
      {
         return this.var_1249 && this.var_993 && this.var_1248;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_44)
         {
            this.var_44.events.removeEventListener(HabboHelpTutorialEvent.const_496,this.onTaskDoneEvent);
            this.var_44.events.removeEventListener(HabboHelpTutorialEvent.const_402,this.onTaskDoneEvent);
            this.var_44.events.removeEventListener(HabboHelpTutorialEvent.const_472,this.onTaskDoneEvent);
            this.var_44 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_38 == null || this.var_38.id == const_86)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_496:
               this.var_1248 = true;
               if(this.var_38 != null && this.var_38.id == const_526)
               {
                  this.showView(const_86);
               }
               break;
            case HabboHelpTutorialEvent.const_402:
               if(this.var_38 != null && this.var_38.id == const_379)
               {
                  this.var_1534 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_1717 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_357:
               ...
               if(this.var_301 == null)
               {
                  this.var_301 = new NameChangeView(this);
               }
               this.var_301.showMainView();
               this.prepareForTutorial();
               break;
            case const_379:
         ...
         this._window.height = _loc2_.height + this.var_1718;
         this._window.width = _loc2_.width + this.var_1717;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_44.hideUI();
         this.var_44.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_112));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_38 != null && (this.var_38.id == const_357 || this.var_38.id == const_86))
         {
            this.showView(const_86);
         }
      }
      ...
      {
         this.var_1249 = true;
         if(this.var_38 != null && (this.var_38.id == const_379 || this.var_38.id == const_86))
         {
            this.showView(const_86);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_301.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_502)
         {
            this.var_301.checkedName = _loc2_.name;
         }
         else
         {
            this.var_301.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
