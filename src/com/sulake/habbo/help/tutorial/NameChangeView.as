package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1389:uint = 13232628;
      
      private static var var_1778:uint = 11129827;
      ...
      private var var_1776:IWindowContainer;
      ...
      private var var_1124:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1776 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_732)
         {
            this.var_732 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_732)
            {
               return;
            }
            this._window.content.addChild(this.var_732);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_733)
         {
            this.var_733 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_733)
            {
               return;
            }
            this._window.content.addChild(this.var_733);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_733.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_482;
         }
         this.showView(this.var_733);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1124 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1124.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1389;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1390)
         {
            if(param1.type == WindowEvent.const_115)
            {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_86);
         }
      }
