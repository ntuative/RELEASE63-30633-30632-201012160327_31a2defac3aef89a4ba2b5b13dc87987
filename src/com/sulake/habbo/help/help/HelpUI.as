package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1572:int = 0;
      
      private static const const_1573:int = 0;
      ...
      {
         this.var_324 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012160236));
         this._toolbar = param5;
         this.var_96 = new Map();
         this.var_96.add(HabboHelpViewEnum.const_1323,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_165,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_404,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_308,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_220,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_567,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_369,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_579,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_231,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_96.add(HabboHelpViewEnum.const_902,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_96.add(HabboHelpViewEnum.const_1058,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_96.add(HabboHelpViewEnum.const_728,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_96.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_96.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_471.length == 0 || param1 != this.var_324)
            {
               this.var_471.push(this.var_324);
            }
         }
         this.var_324 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_324);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_231:
               this.showUI(HabboHelpViewEnum.const_231);
               break;
            case CallForHelpResultEnum.const_1068:
               this.showUI(HabboHelpViewEnum.const_1058);
               break;
            case CallForHelpResultEnum.const_959:
               this.showUI(HabboHelpViewEnum.const_902);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_96.getValue(HabboHelpViewEnum.const_165) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_496));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_96.length)
         {
            _loc3_ = this.var_96.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_96.getValue(this.var_324);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1717 = this._window.width - _loc4_.width;
         this.var_1718 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1718;
         this._window.width = _loc1_.width + this.var_1717;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_471.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_324 == HabboHelpViewEnum.const_165)
         {
            return;
         }
         if(this.var_582.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_582.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_582.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_325.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_582[1],this.var_582[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_582[0],this.var_582[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_324 == HabboHelpViewEnum.const_165 || this.var_471.length == 0)
         {
            return;
         }
         if(this.var_325 == null)
         {
            ...
            this.var_325 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_325.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_325.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_325 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_325 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_325 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
