package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends SearchViewController implements IHelpViewController
   {
      ...
      private static const const_1218:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1218)
         {
      ...
      {
         main.showUI(HabboHelpViewEnum.const_404);
      }
      ...
      private function onCallForHelp(param1:WindowMouseEvent) : void
      {
         ...
         main.showUI(HabboHelpViewEnum.const_369);
      }
      
      private function onReportUser(param1:WindowMouseEvent) : void
      {
         main.component.callForHelpData.reportedUserId = 0;
         main.showUI(HabboHelpViewEnum.const_728);
      }
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc6_ != null)
         {
            main.showUI(HabboHelpViewEnum.const_220);
            main.tellUI(HabboHelpViewEnum.const_220,_loc6_);
         }
      }
