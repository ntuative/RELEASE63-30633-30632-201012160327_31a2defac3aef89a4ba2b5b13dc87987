package com.sulake.habbo.help.register
{
   ...
   public class RegistrationUI
   {
      ...
      private var var_776:RegistrationView;
      ...
      public function showRegistrationView() : void
      {
         if(!this.var_776)
         {
            this.var_776 = new RegistrationView(this);
         }
         this.var_776.showMainView();
      }
      
      public function sendRegistrationEmail(param1:String, param2:String, param3:Boolean) : void
      {
         this.var_161.sendMessage(new SendRegistrationDataComposer(param1,param2,param3));
      }
   }
}
