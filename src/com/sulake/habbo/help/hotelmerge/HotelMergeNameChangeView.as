package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_732)
         {
            this.var_732 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_732)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_733)
         {
            this.var_733 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_733)
            {
               return;
            }
