package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1857:Date;
      
      private var _localizationCode:String;
      
      private var var_182:Boolean = false;
      
      private var var_2619:uint = 2;
      
      private var var_2618:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1808 = param1.roomItemTypeName;
         this.var_1809 = param1.rewardCurrencyAmount;
         this.var_1857 = new Date();
         this.var_1857.setTime(param1.endDateTimeStamp);
      ...
      private function createView() : void
      {
         switch(this._status)
         {
            case QuestStatusEnum.const_41:
               this._view = this.var_67.controller.questEngine.getXmlWindow("QuestEntityAccepted") as IWindowContainer;
               break;
            case QuestStatusEnum.const_410:
               this._view = this.var_67.controller.questEngine.getXmlWindow("QuestEntityAvailable") as IWindowContainer;
               break;
            case QuestStatusEnum.const_170:
               this._view = this.var_67.controller.questEngine.getXmlWindow("QuestEntityExpired") as IWindowContainer;
               break;
            case QuestStatusEnum.const_756:
               this._view = this.var_67.controller.questEngine.getXmlWindow("QuestEntityCompleted") as IWindowContainer;
               break;
            case QuestStatusEnum.const_173:
               this._view = this.var_67.controller.questEngine.getXmlWindow("QuestEntityPreview") as IWindowContainer;
               break;
            default:
               this._view = this.var_67.controller.questEngine.getXmlWindow("QuestEntityExpired") as IWindowContainer;
         }
      ...
      private function updateView() : void
      {
         ...
         {
            case QuestStatusEnum.const_41:
               _loc2_ = ["icon",this.var_67.id,"active"].join("_");
               this.var_67.controller.questEngine.setImageFromAsset(_loc1_,_loc2_,this.onPreviewImageReady);
               break;
            case QuestStatusEnum.const_410:
               break;
            case QuestStatusEnum.const_170:
               break;
            case QuestStatusEnum.const_756:
               this.var_67.controller.questEngine.setImageFromAsset(_loc1_,"icon_complete",this.onPreviewImageReady);
         }
         var _loc3_:String = ["quest",this.var_67.id,this._localizationCode].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            this.var_67.activateListItem(this);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_182)
            {
               this.var_788.style = this.var_2618;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_182)
            {
               this.var_788.style = this.var_2619;
            }
         }
      }
