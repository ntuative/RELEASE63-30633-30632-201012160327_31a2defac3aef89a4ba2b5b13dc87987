package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_103:Quest;
      
      private var _view:IWindow;
      
      private var var_1497:int;
      
      private var var_2013:IScrollableListWindow;
      ...
      {
         switch(this.var_103.type)
         {
            case QuestTypeEnum.FIND_STUFF:
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               this._view = this.var_67.controller.questEngine.getXmlWindow("QuestTypeFindStuff");
               this.var_2013 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
                  throw new Error("[QuestView] Could not create view for quest type: " + this.var_103.type + " !");
               }
               return;
               break;
            default:
               throw new Error("[QuestView] View not defined for quest type: " + this.var_103.type + " !");
         }
      }
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_103)
         {
            this.var_67.controller.activateQuest(this.var_103);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_67.id,this.var_103.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_67.id,"type_" + this.var_103.type.toLowerCase()].join(".");
         ...
         if(this.var_103.type == QuestTypeEnum.FIND_STUFF)
         {
            _loc32_ = this.var_67.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_103.roomItemTypeName);
            if(_loc32_)
            {
               _loc33_ = this.var_67.controller.questEngine.roomEngine.getFurnitureImage(_loc32_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1497 = _loc33_.id;
               if(_loc33_ && _loc33_.data)
               {
                  this.imageReady(_loc33_.id,_loc33_.data);
               }
               this.var_67.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc32_.title);
            }
         }
         else if(this.var_103.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            _loc34_ = this.find("quest.image") as IBitmapWrapperWindow;
            this.var_67.controller.questEngine.setImageFromAsset(_loc34_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else
         {
            this.var_1497 = -1;
         ...
         switch(this.var_103.status)
         {
            case QuestStatusEnum.const_410:
            ...
            case QuestStatusEnum.const_41:
               ...
               break;
            case QuestStatusEnum.const_170:
               this.setText("quest.status","quest.expired");
               _loc16_.visible = true;
               _loc18_ = 4290822336;
               break;
            case QuestStatusEnum.const_756:
         ...
         this.var_67.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_103.rewardCurrencyAmount.toString());
         this.setText("quest.reward.title",_loc13_);
         this.setText("quest.reward.desc",_loc14_);
         var _loc19_:int = this.var_103.endDate.date;
         var _loc20_:int = this.var_103.endDate.month + 1;
         var _loc21_:int = this.var_103.endDate.fullYear;
         var _loc22_:int = this.var_103.endDate.minutes;
         var _loc23_:int = this.var_103.endDate.hours;
         var _loc24_:int = _loc23_ > 11 ? int(_loc23_ - 12) : int(_loc23_);
         var _loc25_:String = _loc23_ < 12 ? "am" : "pm";
         this.var_67.controller.questEngine.localization.registerParameter("quest.available","day",_loc19_.toString());
         this.var_67.controller.questEngine.localization.registerParameter("quest.available","month",_loc20_.toString());
         this.var_67.controller.questEngine.localization.registerParameter("quest.available","year",_loc21_.toString());
         this.var_67.controller.questEngine.localization.registerParameter("quest.available","12h",this.pad(_loc24_));
         this.var_67.controller.questEngine.localization.registerParameter("quest.available","24h",this.pad(_loc23_));
         this.var_67.controller.questEngine.localization.registerParameter("quest.available","ampm",_loc25_);
         this.var_67.controller.questEngine.localization.registerParameter("quest.available","minute",this.pad(_loc22_));
         ...
         var _loc29_:String = "header_" + this.var_67.id;
         this.var_67.controller.questEngine.setImageFromAsset(_loc28_,_loc29_,this.onHeaderImageReady);
         var _loc30_:IBitmapWrapperWindow = this.find("quest.reward.icon") as IBitmapWrapperWindow;
         var _loc31_:String = "icon_" + this.var_67.id + "_reward_" + this.var_103.rewardCurrencyAmount;
         this.var_67.controller.questEngine.setImageFromAsset(_loc30_,_loc31_,this.onRewardImageReady);
         this.updateMargins();
      }
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_67.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onRewardImageReady);
         }
      }
      ...
      private function onHeaderImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_67.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onHeaderImageReady);
         }
      }
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_67.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onPreviewImageReady);
         }
      }
