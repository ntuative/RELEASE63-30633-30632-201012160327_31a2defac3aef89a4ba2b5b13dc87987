package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_445:Quest;
      
      private var var_271:QuestView;
      ...
      private var var_270:IItemListWindow;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_665)
         {
            _loc1_.dispose();
         }
         this.var_665 = [];
      ...
      private function reset() : void
      {
         ...
         if(this.var_306)
         {
            ...
            {
               this.var_270.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_306 = null;
            this.var_270.destroyListItems();
            this.var_270.removeListItems();
         }
         this.var_445 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1021 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1271 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_270 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.id + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1271.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1271.findChildByName("currency.amount").caption = "${quest_" + this.id + ".currency}";
         ...
         this.var_1022 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1022)
         {
            this.var_1022.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1022.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1022.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_445)
         {
            this.var_445.selected = false;
         }
         if(this.var_161)
         {
            this.var_1021.addChild(this.var_161.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1457);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1271.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_306.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_306)
         {
            this.var_270.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_41 || _loc4_.status == QuestStatusEnum.const_410))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_270.maxScrollV > 0)
            {
               this.var_270.scrollV = _loc3_.view.y / this.var_270.maxScrollV;
            }
         }
         else if(this.var_306.length > 0)
         {
            this.activateListItem(this.var_306[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_445 = param1;
         this.var_445.selected = true;
         this.showQuestData(this.var_445);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_271 = new QuestView(this,param1);
         this.var_1021.addChild(this.var_271.view);
         this.var_271.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_665.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_665)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_665.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_665.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_306[_loc3_] = _loc5_;
            _loc6_ = this.var_270.getListItemIndex(_loc2_.view);
            this.var_270.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_270.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_270.addListItem(_loc5_.view);
            }
            if(this.var_445 == _loc2_)
            {
