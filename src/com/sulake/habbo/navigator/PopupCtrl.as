package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_360 = new Timer(500,1);
         this.var_304 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1350 = param4;
         this.var_2140 = param2;
         this._popupIndentLeft = param3;
         this.var_360.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_304.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_360)
         {
            this.var_360.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_360.reset();
            this.var_360 = null;
         }
         if(this.var_304)
         {
            this.var_304.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_304.reset();
            this.var_304 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_49 == null)
         {
            this.var_49 = IWindowContainer(this._navigator.getXmlWindow(this.var_1350));
         ...
         this.var_49.x = _loc2_.x + this.var_2140 + param1.width;
