package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_617:RoomInfoViewCtrl;
      
      private var var_1152:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_359:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2710:Dictionary;
      ...
      private var var_917:GuestRoomPasswordInput;
      
      private var var_323:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_286 = new MainViewCtrl(this);
         this.var_617 = new RoomInfoViewCtrl(this);
         this.var_1152 = new RoomCreateViewCtrl(this);
         this.var_2019 = new RoomThumbnailRenderer(this);
         this.var_917 = new GuestRoomPasswordInput(this);
         this.var_323 = new GuestRoomDoorbell(this);
         this.var_359 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_262,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_617.registerToolbarEvents();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_286.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_286.startSearch(Tabs.const_251,Tabs.const_336,param1);
         this.var_286.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_286.startSearch(Tabs.const_291,Tabs.const_205);
         this.var_359.getTab(Tabs.const_291).tabPageDecorator.tabSelected();
      }
