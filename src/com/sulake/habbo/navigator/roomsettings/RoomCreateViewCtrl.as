package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_959:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_519 = new Timer(100);
         this.var_519.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,540,"t"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,512,"w"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,396,"x"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,440,"y"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,456,"z"));
         this.var_37.push(new RoomLayout(HabboClubLevelEnum.const_50,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_519)
         {
            this.var_519.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_519.reset();
            this.var_519 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_959.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1466 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1466 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_152 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_53 = IItemListWindow(this.var_152.findChildByName("item_list"));
         ...
         var _loc1_:IWindow = this.var_152.findChildByTag("close");
         _loc1_.procedure = this.onCancelButtonClick;
         this.var_958 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_152.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_152.desktop,this.var_152.width,this.var_152.height);
         this.var_152.x = _loc2_.x;
         this.var_152.y = _loc2_.y;
      }
      
      public function refresh() : void
      {
         this.var_958.goBackToInitialState();
         this.var_958.input.textBackgroundColor = 4294967295;
         this.var_959 = this.var_37[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_34,HabboWindowParam.const_59,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         var _loc1_:Boolean = this.var_958.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
         return Boolean(_loc1_);
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_152.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_152.findChildByName("back_button"));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_958.getText();
         var _loc4_:String = "model_" + this.var_959.name;
