package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_399:IRoomSettingsCtrlOwner;
      ...
      private var var_774:TextFieldManager;
      
      private var var_917:TextFieldManager;
      
      private var var_1134:TextFieldManager;
      
      private var var_1139:ICheckBoxWindow;
      
      private var var_1136:ICheckBoxWindow;
      
      private var var_1138:ICheckBoxWindow;
      ...
      private var var_1822:IWindowContainer;
      ...
      private var var_2560:ITextWindow;
      
      private var var_2561:ITextWindow;
      ...
      {
         this.var_340 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_340));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1823 = true;
         this.var_399.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_340)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_340 || this.var_1141 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1141 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1374)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1525)
         {
            this.var_1133.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1357)
         {
            this.setTagError(this.var_775,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_774,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1359)
         {
            this.setTagError(this.var_775,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_774,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1358)
         {
            this.var_917.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function clearErrors() : void
      {
         ...
         this.var_774.clearErrors();
         this.var_917.clearErrors();
         this.var_1134.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_417,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_794,this.onDoorModePasswordUnselect);
         ...
         this.var_775 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_774 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_917 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1134 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1139 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1136 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1138 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_611 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1821 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1404 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1137 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1140 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1822 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1403 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_245 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1135 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2560 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2561 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1820 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1820.procedure = this.onSwitchView;
         this.var_1135.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1821.visible = this._inRoom;
         this.var_1822.visible = this._inRoom;
         this.var_2561.visible = this.var_492;
         this.var_2560.visible = !this.var_492;
         if(this.var_492)
         {
            this.var_1140.visible = true;
            this.var_1403.visible = false;
            this.refreshFlatControllers();
            this.var_1140.height = Util.getLowestPoint(this.var_1140) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1137.visible = true;
            this.var_1403.visible = true;
            this.var_1404.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1404.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1137.height = Util.getLowestPoint(this.var_1137) + 4;
         }
         this.var_1820.text = !!this.var_492 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1821.name,this.var_1404.name,this.var_1137.name,this.var_1140.name,this.var_1403.name,this.var_1822.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_917.setText("");
         this.var_1134.setText("");
         ...
         switch(_loc1_.doorMode)
         {
            case RoomSettingsData.const_171:
               ...
               break;
            case RoomSettingsData.const_105:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_105);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_775,_loc1_.tags[0]);
         this.setTag(this.var_774,_loc1_.tags[1]);
         if(this.var_1139)
         {
            if(_loc1_.allowPets)
            {
               this.var_1139.select();
            }
            else
            {
               this.var_1139.unselect();
            }
         }
         if(this.var_1136)
         {
         ...
         if(this.var_1138)
         {
            ...
            {
               this.var_1138.select();
            }
            else
            {
               this.var_1138.unselect();
            }
         }
         if(this.var_611)
         {
            ...
            {
               this.var_611.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_611.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_105;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_517;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_105)
         {
            _loc8_ = this.var_917.getText();
            _loc9_ = this.var_1134.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_917.clearErrors();
               this.var_1134.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1139.isSelected;
         _loc2_.allowFoodConsume = this.var_1136.isSelected;
         _loc2_.allowWalkThrough = this.var_1138.isSelected;
         _loc2_.hideWalls = this.var_611.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_775,_loc2_.tags);
         this.addTag(this.var_774,_loc2_.tags);
         this.clearErrors();
         this.var_1141 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_340);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_75.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_340]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_146,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_245.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_245.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_245.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_245.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_245.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_245.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_245.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_245);
         this.var_245.findChildByName("ruler").visible = true;
         ...
         if(this.var_75.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_245,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_56,HabboWindowStyle.const_34,HabboWindowParam.const_59,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_340));
      }
