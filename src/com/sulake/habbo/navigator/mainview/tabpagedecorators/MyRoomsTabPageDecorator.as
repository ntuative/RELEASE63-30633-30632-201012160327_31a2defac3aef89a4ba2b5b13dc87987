package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2704:IWindowContainer;
      
      private var var_469:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_469 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_469.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_469 == null ? 0 : int(this.var_469.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         this._navigator.mainViewCtrl.startSearch(Tabs.const_291,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_738;
         }
         if(param1 == 2)
         {
            return Tabs.const_789;
         }
         if(param1 == 3)
         {
            return Tabs.const_618;
         }
         if(param1 == 4)
         {
            return Tabs.const_636;
         }
         return Tabs.const_205;
      }
   }
}
