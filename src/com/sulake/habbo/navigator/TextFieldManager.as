package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         {
            this.var_551 = true;
            this.var_1321 = param5;
            this.var_68.text = param5;
         }
         Util.setProcDirectly(this.var_68,this.onInputClick);
         this.var_68.addEventListener(WindowKeyboardEvent.const_142,this.checkEnterPress);
         this.var_68.addEventListener(WindowEvent.const_115,this.checkMaxLen);
         this.var_2141 = this.var_68.textBackground;
         this._orgTextBackgroundColor = this.var_68.textBackgroundColor;
         this.var_2143 = this.var_68.textColor;
      }
      ...
      {
         this.var_68.textBackground = this.var_2141;
         this.var_68.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_68.textColor = this.var_2143;
      }
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_68.text = this.var_1321;
            this.var_551 = true;
         }
         else
         {
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.text = this.var_2142;
         this.var_551 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > this.var_1558)
         {
            this.var_68.text = _loc2_.substring(0,this.var_1558);
         }
      }
   }
}
