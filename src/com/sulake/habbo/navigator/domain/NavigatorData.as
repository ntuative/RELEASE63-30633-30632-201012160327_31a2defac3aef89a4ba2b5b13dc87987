package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private var var_230:GuestRoomData;
      
      private var var_819:PublicRoomShortData;
      ...
      {
         return this.var_230 != null && !this._currentRoomOwner;
      }
      ...
      public function onRoomEnter(param1:RoomEntryInfoMessageParser) : void
      {
         ...
         {
            this.var_819 = param1.publicSpace;
            this.var_558 = null;
         }
      }
      ...
      public function set categories(param1:Array) : void
      {
         ...
         this.var_1285 = new Array();
         for each(_loc2_ in this.var_1283)
         {
            if(_loc2_.visible)
            {
               this.var_1285.push(_loc2_);
            }
         }
      }
      ...
      {
         var _loc2_:int = 0;
         this.var_2206 = param1.limit;
         this.var_1284 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      public function favouriteChanged(param1:int, param2:Boolean) : void
      {
         ...
         this.var_1284 += !!param2 ? 1 : -1;
      }
      
      public function isCurrentRoomFavourite() : Boolean
      {
         var _loc1_:int = this.var_230.flatId;
      ...
      {
         return this.var_1284 >= this.var_2206;
      }
