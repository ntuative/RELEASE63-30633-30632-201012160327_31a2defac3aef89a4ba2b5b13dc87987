package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_887:uint = 11;
      ...
      private var var_185:IHabboFriendList;
      
      private var var_1144:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_161:IHabboHelp;
      ...
      private var var_615:FramerateTracker = null;
      
      private var var_250:LatencyTracker = null;
      
      private var var_614:LagWarningLogger = null;
      
      private var var_613:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_615 = new FramerateTracker();
         this.var_250 = new LatencyTracker();
         this.var_614 = new LagWarningLogger();
         this.var_613 = new ToolbarClickTracker(this);
         this.var_1412 = new Array(const_887);
         var _loc4_:int = 0;
         while(_loc4_ < const_887)
         {
            this.var_1412[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1429,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1486,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1428,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_633,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1144)
            {
               this.var_1144.release(new IIDHabboWindowManager());
               this.var_1144 = null;
            }
            if(this.var_280)
            {
            ...
            if(this.var_57)
            {
               this.var_57.release(new IIDHabboRoomWidget());
               this.var_57 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_185)
            {
               if(!this.var_185.disposed)
               {
                  Component(this.var_185).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_185).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_185).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_185).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_185).events.removeEventListener(HabboFriendListTrackingEvent.const_356,this.onFriendlistTrackingEvent);
               }
               this.var_185.release(new IIDHabboFriendList());
               this.var_185 = null;
            }
            if(this.var_161)
            {
               if(!this.var_161.disposed)
               {
                  this.var_161.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_161.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_161.release(new IIDHabboHelp());
               this.var_161 = null;
            }
            if(this._toolbar)
            {
               ...
               {
                  this._toolbar.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            ...
            this.trackLoginStep(HabboLoginTrackingStep.const_1380);
            if(this._configuration)
            {
               if(this.var_614 != null)
               {
                  this.var_614.configure(this._configuration);
               }
               if(this.var_615 != null)
               {
                  this.var_615.configure(this._configuration);
               }
               if(this.var_613 != null)
               {
                  this.var_613.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_154);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_768,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_216,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_162,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_188,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_225,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_228,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_574,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_534,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_614 != null)
            {
               this.var_614.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_574)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1365);
         }
         else if(param1.type == HabboHotelViewEvent.const_534)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1330);
         }
         else if(param1.type == HabboHotelViewEvent.const_66)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1386);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1315);
               break;
            case HabboCommunicationEvent.const_768:
               this.trackLoginStep(HabboLoginTrackingStep.const_1342,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_216:
               this.trackLoginStep(HabboLoginTrackingStep.const_216);
               break;
            ...
            case HabboCommunicationEvent.const_162:
               ...
               this.trackLoginStep(HabboLoginTrackingStep.const_162);
               break;
            case HabboCommunicationEvent.const_225:
               ...
               break;
            case HabboCommunicationEvent.const_228:
               this.trackLoginStep(HabboLoginTrackingStep.const_228);
         }
         if(this._communication)
         {
      ...
      {
         this.var_1144 = IHabboWindowManager(param2);
         if(this.var_1144)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1412)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1114);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1114,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_185 = param2 as IHabboFriendList;
         Component(this.var_185).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_185).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_185).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_185).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_185).events.addEventListener(HabboFriendListTrackingEvent.const_356,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_356:
      ...
      {
         this.var_57 = param2 as IRoomWidgetFactory;
         Component(this.var_57).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_57).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_57).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_57).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_161 = param2 as IHabboHelp;
         this.var_161.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_161.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2580)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1513);
            this.var_2580 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_633,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_281,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_280 = param2 as IAdManager;
         this.var_280.events.addEventListener(AdEvent.const_530,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._toolbar = param2 as IHabboToolbar;
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_613)
         {
            this.var_613.track(param1.iconName);
         }
      }
      ...
      {
         this.var_614.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_493 > -1 && _loc2_ < this.var_493)
         {
            ++this.var_1837;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1837);
         }
         if(this.var_493 > -1 && _loc2_ - this.var_493 > 15000)
         {
            ++this.var_1838;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1838);
         }
         this.var_493 = _loc2_;
         if(this.var_249 != null)
         {
            this.var_249.update(param1,this.var_493);
         }
         if(this.var_250 != null)
         {
            this.var_250.update(param1,this.var_493);
         }
         if(this.var_615 != null)
         {
            this.var_615.trackUpdate(param1,this,this.var_493);
         }
         if(this.var_614 != null)
         {
            this.var_614.update(this.var_493);
         }
      }
   }
}
