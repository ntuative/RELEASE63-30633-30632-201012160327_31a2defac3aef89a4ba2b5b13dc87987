package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1549:int = 0;
      
      private const const_1546:int = 1;
      
      private const const_1548:int = 2;
      
      private const const_1545:int = 3;
      
      private const const_1820:int = 0;
      
      private const const_1822:int = 1;
      
      private const const_1824:int = 2;
      
      private const const_1823:String = "xmas10_dialog_bg_png";
      
      private const const_1547:String = "xmas10_dialog_telepair_png";
      
      private const const_1137:String = "xmas10_present_dialog_img_png";
      
      private const const_1821:String = "xmas10_dialog_newbiegift_png";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_440,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_572,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_671,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_440,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_440:
               _loc2_ = this.const_1549;
               this.var_1216 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_671:
               _loc3_ = param1.firstClickUserName;
               if(_loc3_ && _loc3_ != "")
               {
                  _loc2_ = this.const_1545;
                  this._localizations.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc3_);
               }
               else
               {
                  _loc2_ = this.const_1548;
               }
               this.var_1216 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_572:
               _loc2_ = this.const_1546;
               this.var_330 = param1.objectId;
               this.var_1216 = param1.data;
         ...
         if(this.var_1217 != _loc2_ && this._window)
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_1217 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1217)
            {
               ...
               case this.const_1546:
                  ...
                  else if(this._status == this.const_1822)
                  {
                     ...
                     _loc2_ = this.const_1547;
                  }
                  else if(this._status == this.const_1824)
                  {
            ...
            if(_loc4_)
            {
               _loc3_ = (assets.getAssetByName(this.const_1823) as BitmapDataAsset).content as BitmapData;
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_596);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         HabboWebTools.facebookViralGiftPost(_loc2_,_loc3_,this.var_1216,_loc4_);
         this.hideInterface();
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_640,"ViralGift",param1,param2,param3);
