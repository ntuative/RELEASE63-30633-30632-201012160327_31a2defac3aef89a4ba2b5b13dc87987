package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_548:int = 10;
      
      private static const const_842:int = 16;
      
      private static const const_1173:int = 40;
      
      private static const const_1553:int = 5;
      ...
      private var var_463:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_997 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2097 = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this._chatModeIdSpeak = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_789 = new Timer(1000,1);
         this.var_789.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_996 = new Timer(5000,1);
         this.var_996.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
         this.refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_56,HabboWindowStyle.const_37,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_142,this.windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_45,this.onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_115,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_373,this.onWindowMoved);
         this.var_1542 = true;
         this.var_435 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         this.var_2098 = _loc2_.width + const_842 + _loc6_.width + const_1172;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1173,_loc8_.width) + const_842);
            _loc8_.x = _loc12_;
      ...
      {
         this.var_463 = param1 - this.var_2098;
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),this.var_463);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,this.var_463);
         }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_38,this.windowMouseEventProcessor);
         }
      }
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_997 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_435 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_435.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_435 = _loc2_.text;
            if(!this.var_790)
            {
               this.var_790 = true;
               this.var_789.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_790);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_463)
         {
