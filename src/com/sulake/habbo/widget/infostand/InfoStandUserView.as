package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_63:IItemListWindow;
      
      private var var_211:IBorderWindow;
      
      private var var_960:TagListRenderer;
      
      private var var_123:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_960 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc4_:* = [];
         this.var_63.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_.addEventListener(WindowEvent.const_45,this.onButtonResized);
         }
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_211.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_211.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < this.var_63.numListItems)
            {
               _loc13_ = this.var_63.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_211.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = this.var_211.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_123.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_123.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_123.x = _loc5_.left - this.var_123.width;
         this.var_123.y = _loc5_.top + (_loc5_.height - this.var_123.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_123.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_123.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_123.x = _loc7_.left - this.var_123.width;
         this.var_123.y = _loc7_.top + (_loc7_.height - this.var_123.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_123 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_123 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_960.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_63.getListItemByName(param1) as IRegionWindow;
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_204:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_208:
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this.var_63.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_991:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_892:
