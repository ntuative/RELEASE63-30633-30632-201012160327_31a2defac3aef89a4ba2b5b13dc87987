package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_211:IBorderWindow;
      
      private var var_63:IItemListWindow;
      
      private var var_50:IItemListWindow;
      
      private var var_175:PetCommandTool;
      
      private var var_1270:Map;
      
      private var var_587:int;
      
      private const const_1837:int = 158;
      
      private const const_1836:int = 16;
      
      private const const_1838:uint = 11184810;
      
      private const const_1831:uint = 6710886;
      
      private const const_1834:uint = 3355443;
      
      private const const_1833:String = "level";
      
      private const const_1835:String = "experience";
      
      private const const_1832:String = "energy";
      
      private const const_1839:String = "nutrition";
      ...
      {
         if(this.var_50 == null || this.var_211 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this.var_211.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_211.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_211.width < this.var_63.width)
         {
            this.var_211.x = this._window.width - this.var_211.width;
            this.var_63.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1833,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1835,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1832,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1839,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_587 = param1.id;
         this.var_1270.remove(param1.id);
         this.var_1270.add(param1.id,param1);
         if(this.var_175 && this.var_175.isVisible() && param1.isOwnPet)
         {
            this.var_175.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         this.var_175.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1837,this.const_1836,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1838);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1834);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1831);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_175 == null)
         {
            this.var_175 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1270.getValue(this.var_587) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_175.showWindow(true);
            this.var_175.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_211 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_211 != null)
         {
            this.var_50 = this.var_211.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_211.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_175 && this.var_175.getPetId() == this.var_587)
               {
                  this.var_175.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_498,this._widget.petData.ownerId);
