package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1211:int = 9;
      
      private static const const_855:int = 10;
      
      private static const const_555:int = 25;
      
      private static const const_1212:int = 25;
      
      private static const const_856:int = 4000;
      
      private static const const_1209:int = 6000;
      
      private static const const_1213:int = 3;
      
      private static const const_1210:int = 1;
      
      private static const const_554:int = 8;
      
      private static const const_391:int = 0;
      
      private static const const_857:int = (const_554 + const_391) * const_101 + const_101;
      ...
      private var var_204:int = 171.0;
      
      private var var_841:int = 18;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_35 = param1.createWindow("chat_container","",HabboWindowType.const_56,HabboWindowStyle.const_34,HabboWindowParam.const_37,new Rectangle(0,0,200,this.var_204 + RoomChatHistoryPulldown.const_77),null,0) as IWindowContainer;
         this.var_35.background = true;
         this.var_35.color = 33554431;
         this.var_35.tags.push("room_widget_chat");
         this.var_317 = param1.createWindow("chat_contentlist","",HabboWindowType.const_953,HabboWindowStyle.const_37,0 | 0,new Rectangle(0,0,200,this.var_204),null,0) as IItemListWindow;
         this.var_35.addChild(this.var_317);
         this.var_109 = param1.createWindow("chat_active_content","",HabboWindowType.const_56,HabboWindowStyle.const_37,HabboWindowParam.const_59,new Rectangle(0,0,200,this.var_204),null,0) as IWindowContainer;
         this.var_109.clipping = false;
         this.var_317.addListItem(this.var_109);
         this.var_27 = new RoomChatHistoryViewer(this,param1,this.var_35,param2);
         this.var_2298 = param4.getKey("site.url");
         this.var_2299 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1055 && this.var_1055 > 0)
         {
            this.var_1055 = -1;
            this.animationStart();
         }
         if(this.var_840)
         {
            _loc2_ = param1 / const_1212 * const_1213;
            if(_loc2_ + this.var_838 > this.var_841)
            {
               _loc2_ = this.var_841 - this.var_838;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_838 >= this.var_841)
            {
               this.var_841 = const_101;
               this.var_838 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1055 = getTimer() + const_856;
            }
         }
         if(this.var_27 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_705,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_278,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_577,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_663,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_705,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_278,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_577,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_663,this.onRoomViewUpdate);
      }
      
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2298);
         _loc2_.define(param1);
         if(this.var_839 != 1)
         {
            _loc2_.senderX /= this.var_839;
         }
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1658 == 0)
            {
               this.var_1658 = param1.scale;
            }
            else
            {
               this.var_839 = param1.scale / this.var_1658;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_685.x += param1.positionDelta.x / this.var_839;
            this.var_685.y += param1.positionDelta.y / this.var_839;
         }
         if(param1.rect != null)
         {
            if(this.var_27 == null)
            ...
            this.var_35.height = this.var_204 + this.var_27.pulldownBarHeight;
            this.var_317.width = this.var_35.width - this.var_27.scrollbarWidth;
            this.var_317.height = this.var_204;
            this.var_317.x = this.var_35.x;
            this.var_317.y = this.var_35.y;
            this.var_109.width = this.var_35.width - this.var_27.scrollbarWidth;
            this.var_109.height = this.var_204;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_66.length > const_1210 || this.historyViewerActive() && this.var_66.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_841 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_66[0]);
            }
            else
            {
               this.var_841 = const_101;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_391 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1209)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_685.x) * this.var_839;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_35.width / 2 - const_855;
         var _loc6_:Number = this.var_35.width / 2 + const_855 - this.var_27.scrollbarWidth;
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_204 + this.var_35.y;
      }
      ...
      {
         return "chat_" + this.var_2300.toString() + "_item_" + (this.var_2297++).toString();
      }
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_204 = param1 - this.var_35.y;
         this.var_35.height = this.var_204 + RoomChatHistoryPulldown.const_77;
         if(this.var_27 != null)
         {
            this.var_27.containerResized(this.var_35.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_204 = const_857 + const_390;
         this.var_35.height = this.var_204 + this.var_27.pulldownBarHeight;
         this.var_317.width = this.var_35.width - this.var_27.scrollbarWidth;
         this.var_317.height = this.var_204;
         this.var_109.width = this.var_35.width - this.var_27.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_109.height = this.getTotalContentHeight() + const_390;
         }
         else
         {
            this.var_109.height = this.var_204;
         }
         this.var_317.scrollV = 1;
         if(!this.historyViewerActive())
         {
            this.var_27.containerResized(this.var_35.rectangle);
         }
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1031)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_857)
         {
            if(_loc1_ <= this.var_204 + this.var_35.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1659 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1659 = false;
         }
