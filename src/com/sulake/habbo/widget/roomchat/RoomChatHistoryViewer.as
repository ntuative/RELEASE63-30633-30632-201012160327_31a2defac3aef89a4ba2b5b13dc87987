package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1243:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_645 = false;
         this._widget = param1;
         this.var_165 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_165.state = RoomChatHistoryPulldown.const_242;
         ...
         this.var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_921,HabboWindowStyle.const_37,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_165.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_242);
      }
      ...
      {
         return !!this.var_388 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_165.state == RoomChatHistoryPulldown.const_313 || this.var_165.state == RoomChatHistoryPulldown.const_406;
      }
      ...
      {
         if(!this.var_388 && !this.var_1578)
         {
            this.var_388 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_165.state = RoomChatHistoryPulldown.const_313;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_43 != null)
         {
            ...
            if(param2)
            {
               this.var_43.scrollV = this.var_595;
            }
         }
         if(this.var_165 != null)
         {
            this.var_165.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_387 > 0 && param2)
         {
            if(this.var_1746)
            {
               if(Math.abs(param1 - this.var_387) <= const_1031)
               {
                  return;
               }
               this.var_1746 = false;
            ...
            if(this.var_388)
            {
               ...
               _loc3_ = this.var_595 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_387;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_43.scrollV < 1 - const_1243 / this.var_43.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1747)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_43 != null)
         {
            this.var_595 = this.var_43.scrollV;
         }
         if(this.var_43 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_595 - this.var_43.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
