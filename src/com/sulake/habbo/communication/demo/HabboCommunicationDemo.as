package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_46:IHabboCommunicationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_18:IRoomSessionManager;
      
      private var var_455:IKeyExchange;
      
      private var var_835:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2278:PseudoRandom;
      ...
      private var var_203:HabboHotelView;
      
      private var var_1308:String = "";
      
      private const const_1561:String = "fuselogin";
      ...
      public function get include() : IHabboCommunicationManager
      {
         return this.var_46;
      }
      ...
      {
         if(param1 && !this.var_571)
         {
            this.var_571 = param1;
            this.var_46.initConnection(HabboConnectionType.const_210);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_89,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_46 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_46.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_46.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_46.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_46.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_46.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_46.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_46.addHabboConnectionMessageEvent(new StartRegistrationEvent(this.onStartRegistration));
            this.var_46.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_46.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_46.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_46.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_46.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_46.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_46.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_46.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_46 && this._habboConfiguration && this.var_18 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_203 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_203.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this._habboConfiguration.getKey("use.sso.ticket") == "1";
         this.var_571 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1653 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2279 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_203 == null)
         {
            this.var_203 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_46.mode = HabboConnectionType.const_114;
            if(this.var_571)
            {
               this.var_46.initConnection(HabboConnectionType.const_210);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_448,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_46.mode = HabboConnectionType.const_988;
            }
         }
         this.var_46.initConnection(HabboConnectionType.const_210);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_46.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_768);
            _loc3_ = new InitCryptoMessageComposer(this.var_46.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2278 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_46.mode)
         {
            case HabboConnectionType.const_114:
               _loc6_ = "";
               ...
               this.var_1308 = _loc4_;
               this.var_203.loadBannerImage(_loc7_ + "?token=" + this.var_1308,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_988:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1282:
               this.var_835 = this.generateRandomHexString(30);
               this.var_455 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_455.init(this.var_835);
               _loc8_ = this.var_455.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_46.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_455.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_455.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2278);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1307 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_216);
         connection.send(new VersionCheckMessageComposer(401,this.var_1653,this.var_2279));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1561,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_571 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_571);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_162);
         }
      ...
      {
         var _loc4_:IConnection = this.var_46.getHabboMainConnection(null);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_225);
      }
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_228);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1307)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_188);
         }
         if(param1.type == Event.CLOSE && !this.var_2280)
         {
      ...
      {
         if(!this.var_18.sessionStarting)
         {
            this.showHotelView();
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1308);
         ...
         var _loc9_:IConnection = this.var_46.getHabboMainConnection(null);
         ...
         this.var_455 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_455.init(_loc14_);
            _loc15_ = this.var_455.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_835 = _loc14_;
            }
