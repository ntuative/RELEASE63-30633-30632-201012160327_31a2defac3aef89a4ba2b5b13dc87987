package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1340:uint = 1;
      
      public static const const_1344:uint = 2;
       
      
      private var var_1219:IProtocolEncoder;
      
      private var var_969:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1219 = new WedgieEncoder();
         this.var_969 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1340)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_969.getID(_loc4_);
