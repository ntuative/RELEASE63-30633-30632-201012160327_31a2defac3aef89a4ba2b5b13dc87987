package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private var var_1300:IMessageConfiguration;
      ...
      private var var_1405:Timer;
      
      private var var_918:int = 1;
      
      private var var_126:String = "";
      ...
      {
         this.var_1300 = new HabboMessages();
         this.var_247 = [];
         this.var_1405 = new Timer(100,1);
      ...
      {
         if(this.var_247.length == 0 || this.var_400 < 0 || this.var_400 >= this.var_247.length)
         {
            return 0;
         }
         return this.var_247[this.var_400];
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_285)
         {
            this.var_285.release(new IIDCoreCommunicationManager());
            this.var_285 = null;
         }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_285 = param2 as ICoreCommunicationManager;
            this.var_285.connectionStateListener = this;
            this.var_285.registerProtocolType(HabboProtocolType.const_1038,WedgieProtocol);
            this._connection = this.var_285.createConnection(HabboConnectionType.const_210,ConnectionType.const_931);
            _loc3_ = this.var_285.getProtocolInstanceOfType(HabboProtocolType.const_1038);
            this._connection.registerMessageClasses(this.var_1300);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!_loc4_)
            {
               Core.crash("Tried to connect to an invalid host: " + this.var_33,Core.const_292);
               return;
            }
            _loc5_ = _loc3_.split(",");
      ...
      public function initConnection(param1:String) : void
      {
         switch(param1)
         {
            case HabboConnectionType.const_210:
      ...
      private function nextPort() : void
      {
         ...
         if(this.var_400 >= this.var_247.length)
         {
            ...
            if(this.var_918 > _loc1_)
            {
               ...
               this.var_2571 = true;
               Core.error("Connection failed to host " + this.var_33 + " ports " + this.var_247,true,Core.const_292);
               return;
            }
            this.var_400 = 0;
         }
         this._connection.timeout = this.var_918 * 10000;
         this._connection.init(this.var_33,this.var_247[this.var_400]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_247[this.var_400]);
         this.tryNextPort();
      }
      ...
      {
         this.var_1405.addEventListener(TimerEvent.TIMER,this.onTryNextPort);
         this.var_1405.start();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_247[this.var_400]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_285 ? this.var_285.queueConnection(HabboConnectionType.const_210,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_285)
         {
            this.var_285.addConnectionMessageEvent(HabboConnectionType.const_210,param1);
         }
      }
      ...
      public function connectionInit(param1:String, param2:int) : void
      {
         ...
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1406,String(param2));
      }
      
      public function messageReceived(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1487,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1475,param1 + " " + param2);
         if(this.var_126.length > 0)
         {
            this.var_126 += ",R:" + param1;
         }
         else
         {
            this.var_126 = "R:" + param1;
         }
         if(this.var_126.length > 150)
         {
            this.var_126 = this.var_126.substring(this.var_126.length - 150);
         }
         ErrorReportStorage.addDebugData("MESSAGE_QUEUE",this.var_126);
      }
      
      public function messageSent(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1256,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1430,param1 + " " + param2);
         if(this.var_126.length > 0)
         {
            this.var_126 += ",S:" + param1;
         }
         else
         {
            this.var_126 = "S:" + param1;
