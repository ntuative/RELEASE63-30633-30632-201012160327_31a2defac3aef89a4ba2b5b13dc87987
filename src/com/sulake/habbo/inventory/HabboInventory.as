package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1093:IRoomSession;
      ...
      private const const_1848:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_18 != null)
         {
            ...
            this.var_18.events.removeEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
            this.var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_521,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_47.getValue(InventoryCategory.const_79));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_47.getValue(InventorySubCategory.const_300));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_47.getValue(InventoryCategory.const_632));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_47.getValue(InventoryCategory.const_289));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_47.getValue(InventoryCategory.const_380));
      }
      ...
      {
         return PetsModel(this.var_47.getValue(InventoryCategory.const_144));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_47.getValue(InventoryCategory.const_364) as MarketplaceModel;
      }
      ...
      public function get clubLevel() : int
      {
         ...
         {
            return HabboClubLevelEnum.const_50;
         }
      ...
      {
         this.var_356 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
         this.var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_521,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_89:
               this.var_1093 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_521:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_356 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_18 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_47.add(InventoryCategory.const_364,_loc1_);
         ...
         this.var_47.add(InventoryCategory.const_79,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_356);
         this.var_47.add(InventoryCategory.const_289,_loc3_);
         ...
         this.var_47.add(InventoryCategory.const_632,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_356);
         this.var_47.add(InventoryCategory.const_380,_loc5_);
         ...
         this.var_47.add(InventorySubCategory.const_300,_loc6_);
         ...
         this.var_47.add(InventoryCategory.const_144,_loc8_);
         this.var_172 = true;
         if(this.var_2450)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_300:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_875.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_875.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_875.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_875.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1848);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_975));
      }
