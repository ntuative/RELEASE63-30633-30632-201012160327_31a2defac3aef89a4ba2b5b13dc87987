package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_766:int = 0;
      
      protected var var_624:BitmapData;
      
      protected var var_1944:int;
      
      protected var var_1428:Boolean;
      
      protected var var_1894:Boolean;
      
      protected var var_2631:BitmapData;
      
      private const const_1843:int = 8947848;
      
      private const const_1842:int = 13421772;
      
      private const const_1575:Number = 1;
      
      private const const_1574:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1346));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1887);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_766 = _loc1_.id;
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_690)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1574;
               _loc1_.blend = this.const_1574;
            }
            else
            {
               this._window.blend = this.const_1575;
               _loc1_.blend = this.const_1575;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1894 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2631;
               _loc5_.visible = true;
            }
            else
            {
