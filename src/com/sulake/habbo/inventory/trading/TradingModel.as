package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1504:uint = 9;
      ...
      public static const const_259:uint = 3;
      
      public static const const_469:uint = 4;
      
      public static const const_245:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_1933 = param5;
         this.var_770 = new Map();
         this.var_948 = false;
         this._otherUserCanTrade = param6;
         this.var_678 = true;
         this.state = const_160;
         this.var_48.setup(param1,param3,param4,param6);
         this.var_48.updateItemList(this.var_630);
         this.var_48.updateItemList(this.var_1188);
      ...
      public function close() : void
      {
         if(this.var_678)
         {
            if(this._state != const_177 && this._state != const_245)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_177;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_909);
            this.var_678 = false;
         }
      ...
      {
         this.var_48.setMinimized(param1 != InventoryCategory.const_79);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_629 + " OTHER: " + this.var_948);
         ...
         {
            case const_177:
               if(param1 == const_160 || param1 == const_245)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_259.length)
         {
            _loc2_ = this.var_259.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_48.alertPopup(TradingView.const_1023);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_630)
            {
               this.var_629 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_948 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_48.updateUserInterface();
         }
         else if(param1 is TradingConfirmationEvent)
         {
            ...
            this.state = const_332;
         }
         else if(param1 is TradingCompletedEvent)
         {
            Logger.log("TRADING::TradingCompletedEvent");
            this.state = const_245;
         }
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_630)
            {
               this.var_48.alertPopup(TradingView.const_997);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_259.length < const_1504)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_147)
            {
               _loc6_ = String(param2) + "poster" + param5;
            }
            if(this.var_259.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
