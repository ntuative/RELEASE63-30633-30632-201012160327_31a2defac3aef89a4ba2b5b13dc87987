package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_841:uint = 4284532064;
      
      private static const const_840:uint = 2577770;
      
      public static const const_978:int = 0;
      ...
      private var var_358:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_358 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_174)
            {
               this.var_174.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_174.stop();
               this.var_174 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1535 = this.createMinimizedWindow();
         }
         if(!this.var_2092)
         {
            return this.var_64;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_841) : uint(const_840);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_841) : uint(const_840);
            }
         ...
         if(this.var_64)
         {
            ...
            switch(this.var_22.state)
            {
               ...
               case TradingModel.const_259:
                  ...
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_469:
                  _loc1_.disable();
                  this.showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_245:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_174 = new Timer(1000,3);
            this.var_174.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_174.reset();
         this.var_174.repeatCount = 3;
         this.var_174.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_174.currentCount));
         if(this.var_174.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_147)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1030)
            {
            ...
            this.var_358.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_419);
            this.var_358.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_358.hideDelayed();
         }
      }
