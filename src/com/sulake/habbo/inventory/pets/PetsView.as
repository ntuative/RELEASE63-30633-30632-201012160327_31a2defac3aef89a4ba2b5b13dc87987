package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         this.var_446 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_328);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_588.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_446.removeGridItem(_loc2_.window);
         if(this.var_328 == _loc2_)
         {
            this.var_328 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_588 == null || this.var_588.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_588.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_588.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_446.addGridItem(_loc2_.window);
            this.var_588.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_328.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_60)
         {
            ...
            {
               case "tab_floor":
                  this.var_62.switchCategory(FurniModel.const_40);
                  break;
               case "tab_wall":
                  this.var_62.switchCategory(FurniModel.const_44);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_328 != null)
         {
            this.var_328.setSelected(false);
         }
         this.var_328 = param1;
         if(this.var_328 != null)
         {
            this.var_328.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = this._avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_46,this);
            if(_loc13_ == null)
            {
               return;
            }
            _loc13_.setDirection(AvatarSetType.const_32,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_32);
            _loc3_ = _loc12_.name;
