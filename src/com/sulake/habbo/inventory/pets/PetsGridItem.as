package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      public function PetsGridItem(param1:PetsView, param2:PetData, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IAvatarRenderManager)
      {
         ...
         var _loc7_:IAvatarImage = param5.createPetImageFromFigure(param2.figure,AvatarScaleType.const_46);
         if(_loc7_ == null)
         {
            return;
         }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_38:
               this.var_1331.setSelectedGridItem(this);
               this.var_1330 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1330 = false;
                  this.var_1331.placePetToRoom(this.var_1270.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1843) : uint(this.const_1842);
      }
