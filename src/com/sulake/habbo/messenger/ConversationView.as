package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_839:int = 100;
      
      private static const const_1171:int = 20;
       
      
      private var var_127:HabboMessenger;
      
      private var var_2062:IScrollbarWindow;
      
      private var var_1526:IContainerButtonWindow;
      
      private var var_53:IItemListWindow;
      
      private var var_434:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_127 = param1;
         this.var_1526 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_53 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2062 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_839 + const_1171)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1170;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_434 == null || _loc1_.id != this.var_434.id)
         {
            this.var_434 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_434.followingAllowed)
         {
            this.var_1526.enable();
         }
         else
         {
            this.var_1526.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_53.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_434.messages.length - const_839);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_434.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_434.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_667 || param3.type == Message.const_803 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_434.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_127.send(new FollowFriendMessageComposer(this.var_434.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_803)
         {
            return 4292801535;
         }
         if(param1 == Message.const_973)
         {
            return 4294927974;
         }
         if(param1 == Message.const_595)
         {
            return 4293454056;
         }
         if(param1 == Message.const_810)
         {
            return 4293454056;
         }
         if(param1 == Message.const_998)
         {
            return 4288269465;
         }
         return 4291611852;
