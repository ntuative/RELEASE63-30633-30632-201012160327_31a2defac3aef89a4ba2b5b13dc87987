package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_387:uint = 3;
      
      private static const const_1195:uint = 1;
      ...
      private var var_824:ISkinContainer;
      
      private var var_311:Array;
      
      private var var_1295:IEventDispatcher;
      
      private var var_1042:Boolean = false;
      
      private var var_1633:ProfilerOutput;
      
      private var var_1294:ProfilerAgentTask;
      
      private var var_1293:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_824 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_824);
         this.var_177 = new Array(const_387);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_387)
         {
            this.var_177[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_220 = this.var_177[const_1195];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this.var_220.getMouseCursor().defineCustomCursorType(MouseCursorType.const_315,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this.var_220.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1442,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1633)
            {
               this.var_1633 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1633.profiler = _loc3_;
            this.var_1294 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1294);
            this.var_1293 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1293);
            this.var_1042 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_177)
            {
               ...
               {
                  IDisposable(this.var_177.pop()).dispose();
               }
            }
            this.var_177 = null;
            if(this.var_311)
      ...
      {
         return this.var_220.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_220.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_311[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_311[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_824.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_177[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_177[param2].getDesktopWindow();
      ...
      {
         return this.var_177[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_177[param1].getDesktopWindow().getChildAt(this.var_220.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_177[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_346.length > 0)
         {
            this.var_1295.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_387 - 1;
            while(_loc2_ >= 0)
            {
               this.var_177[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1042)
         ...
         this.var_1295.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_387)
         {
            this.var_177[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1042)
         {
         ...
         if(WindowContext.var_346.length > 0)
         {
            WindowContext.var_346.flush();
         }
         this.var_1295.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1490,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1423,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1460,param2.name + ": " + param2.toString());
            }
         }
      }
   }
