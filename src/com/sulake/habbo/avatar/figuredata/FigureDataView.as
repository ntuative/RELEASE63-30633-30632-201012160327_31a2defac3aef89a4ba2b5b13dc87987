package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            this.var_1053 = _loc4_.content as BitmapData;
         }
         if(this._window != null)
         {
            this.var_357 = this._window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      
      public function udpate(param1:BitmapData) : void
      {
         if(this.var_357 && this.var_1053)
         {
            this.var_357.bitmap = new BitmapData(this.var_357.width,this.var_357.height,true,16777215);
            this.var_357.bitmap.copyPixels(this.var_1053,this.var_1053.rect,new Point(0,this.var_357.height - this.var_1053.height - 8));
            this.var_357.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
