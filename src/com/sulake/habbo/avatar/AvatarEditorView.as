package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1159:IWindowContainer;
      
      public static var var_1420:IWindowContainer;
      
      public static var var_1861:int = 6710886;
      ...
      private var var_500:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_499:IFrameWindow;
      ...
      private var var_2605:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1154 = [];
         this.var_1283 = [AvatarEditorFigureCategory.const_706,AvatarEditorFigureCategory.const_43,AvatarEditorFigureCategory.const_206,AvatarEditorFigureCategory.const_641,AvatarEditorFigureCategory.const_1052,AvatarEditorFigureCategory.const_100];
         super();
         ...
         if(var_1159 == null)
         {
            ...
            var_1159 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1420 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1420 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_404 = new Timer(1000);
         this.var_404.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1283;
         }
         for each(_loc6_ in param4)
         {
            this.var_1154.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_404.stop();
            this.var_404.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_404 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1283);
         }
         if(param1.length != this.var_1154.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1154.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2606 = this.canChangeOutfit();
            this.var_404.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_500 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_500.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_500.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1154.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_500.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_500.numSelectables)
               {
                  this.var_500.getSelectableAt(_loc6_).x = this.var_500.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1283;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1853 == AvatarEditorSideCategory.const_100 || this.var_2605))
         {
         ...
         this.setViewToCategory(this.var_324);
      }
      ...
      {
         if(this.var_1853 == AvatarEditorSideCategory.const_100)
         {
            this.var_2605 = false;
            this.setSideContent(AvatarEditorSideCategory.const_653);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_653:
               break;
            case AvatarEditorSideCategory.const_509:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_509);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_324 = param1;
         this.var_500.setSelected(this.var_500.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_499)
         {
            ...
            this.var_499 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_499.procedure = this.stripClubDialogEventProc;
            this.var_499.center();
         }
         else
         {
            this.var_499.visible = true;
            this.var_499.center();
         }
      }
