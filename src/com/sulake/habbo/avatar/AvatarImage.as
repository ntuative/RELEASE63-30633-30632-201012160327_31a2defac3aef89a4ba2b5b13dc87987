package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1190:String = "Default";
      
      private static const const_1191:int = 2;
      
      private static const const_1192:String = AvatarSetType.const_32;
      ...
      protected var var_1889:int;
      
      protected var var_254:IActiveActionData;
      
      protected var var_645:Boolean;
      
      protected var var_752:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_248:AvatarImageCache;
      
      protected var var_584:AvatarFigureContainer;
      
      protected var var_506:IAvatarDataContainer;
      
      protected var var_287:Array;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1192,const_1191);
         this.var_287 = new Array();
         this.var_844 = new ActiveActionData(AvatarAction.const_339);
         this.var_844.definition = this._structure.getActionDefinition(const_1190);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_584,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1589;
         if(param2 < AvatarDirectionAngle.const_925)
         {
            param2 = AvatarDirectionAngle.const_264 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_264)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_554,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_269.length == 1 && this.var_84 == this.var_1889)
         {
            return this.var_84 + this.var_444 + this.var_554 % 4;
         }
         if(this.var_269.length == 2)
         {
            for each(_loc1_ in this.var_269)
            {
               ...
               {
                  return this.var_84 + this.var_444 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_554 % 11;
                  return this.var_84 + "_" + this.var_1889 + this.var_444 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2178 || param2 != this.var_2180 || param1 != this.var_2179)
         {
            this.var_2178 = param3;
            this.var_2180 = param2;
            this.var_2179 = param1;
            this.var_1588 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_254.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1172 || this.var_39 == null || (this.var_39.width != _loc5_.width || this.var_39.height != _loc5_.height))
         {
            if(this.var_39 != null && !this.var_1172)
            {
               this.var_39.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_254.definition.geometryType,this.var_84);
         this.var_39.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_554);
         ...
         {
            if(this.var_506.paletteIsGrayscale)
            {
               ...
               this.var_39 = _loc13_;
               this.var_39.paletteMap(this.var_39,this.var_39.rect,new Point(0,0),this.var_506.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_254.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_254.definition.geometryType,this.var_84);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_554);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_287.push(new ActiveActionData(param1,param2,this.var_554));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_254 = this.var_844;
         this.var_254.definition = this.var_844.definition;
         this.resetBodyPartCache(this.var_844);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_444 = "";
         this.var_269 = this._structure.sortActions(this.var_287);
         if(this.var_269 == null)
         {
            this.var_752 = new Array(0,0,0);
            if(this.var_1267 != "")
            {
               _loc1_ = true;
               this.var_1267 = "";
         ...
         {
            this.var_752 = this._structure.getCanvasOffsets(this.var_269,this._scale,this.var_84);
            for each(_loc4_ in this.var_269)
            {
               this.var_444 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_301)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1269 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1269 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1267 != this.var_444)
            {
               _loc1_ = true;
               this.var_1267 = this.var_444;
            }
         }
         this.var_1268 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_269)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_840 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1589 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_506 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_295 || _loc1_.actionType == AvatarAction.const_203 || _loc1_.actionType == AvatarAction.const_328)
               {
                  this.var_840 = true;
               }
            }
