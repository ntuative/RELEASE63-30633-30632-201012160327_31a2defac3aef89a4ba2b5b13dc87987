package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1681:Number = 1.0;
      
      private var var_1680:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1095:Map;
      
      private var var_2455:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_1732 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2456 = parseInt(_loc2_,16);
         this.var_2457 = parseInt(_loc3_,16);
         ...
         this.var_1719 = new ColorTransform(this.var_1682,this.var_1681,this.var_1680,this._alphaMultiplier);
         this.var_1095 = this.generatePaletteMapForGrayscale(this.var_2457,this.var_2456);
      }
      ...
      {
         return this.var_1095.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1095.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1095.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1095.getValue("alphas") as Array;
      }
