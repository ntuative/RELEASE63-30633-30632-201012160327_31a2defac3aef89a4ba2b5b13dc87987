package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1626:String = "hot_looks";
      
      public static const const_1781:String = "my_looks";
      ...
      {
         super(param1);
         this.var_430 = new Dictionary();
         this.var_430["null"] = new Array();
         this.var_430["null"] = new Array();
         this.var_430["undefined.index"] = 0;
         this.var_430["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_430["null"];
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_430[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
