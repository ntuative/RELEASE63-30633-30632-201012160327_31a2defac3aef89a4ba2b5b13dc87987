package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1586:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1342:IAvatarImage;
      ...
      private var var_612:AvatarCanvas;
      
      private var _disposed:Boolean;
      
      private var _bodyPartCache:AvatarImageBodyPartCache;
      
      private var var_342:IActiveActionData;
      
      private var var_357:AvatarImageBodyPartContainer;
      
      private var var_1406:String;
      
      private var var_113:AvatarImagePartContainer;
      
      private var var_2574:Point;
      ...
      private var var_2575:ByteArray;
      
      private var var_2576:ImageData;
      
      private var var_1832:PaletteMap;
      
      private var var_919:Array;
      
      private var var_920:Point;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_248.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_248.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_248.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_248.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_248.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_248.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      {
         if(this.var_743 == param1)
         {
            return;
         }
         if(this.var_743 == GeometryType.const_1108 && param1 == GeometryType.const_1101 || this.var_743 == GeometryType.const_1101 && param1 == GeometryType.const_1108)
         {
            this.var_743 = param1;
            this.var_612 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_248.add(param1,this._bodyPartCache);
         }
         var _loc3_:int = this._bodyPartCache.getDirection();
         var _loc4_:int = param2;
         this.var_342 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_342;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_342 || !this.var_342.definition))
         {
            if(this.var_342.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_342.definition.state + "." + this.var_342.actionParameter);
               _loc13_ = param2 - this.var_342.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_342.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_342 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_570)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1342.getFigure(),_loc5_,this.var_743,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_357 = _loc10_.getImageContainer(_loc4_);
         if(this.var_357 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_357 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_342);
            if(this.var_357 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_357,_loc4_);
         }
         this.var_357.offset = _loc8_;
         return this.var_357;
      }
      
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_248.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_248.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_612)
         {
            this.var_612 = this._structure.getCanvas(this._scale,this.var_743);
            if(!this.var_612)
            {
               return null;
            }
            this.var_2574 = new Point(0,this.var_612.height - int(this.var_612.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1427[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_800 || _loc10_ == AvatarAction.const_328;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1406 = this.var_113.bodyPartId;
               this.var_168 = this.var_113.partType;
               this.var_1831 = this.var_113.partId;
               ...
               this.var_1407 = this._scale + "_" + this.var_113.action.assetPartDefinition + "_" + this.var_168 + "_" + this.var_1831 + "_" + _loc5_ + "_" + this._frame;
               this.var_401 = this._assets.getAssetByName(this.var_1407) as BitmapDataAsset;
               if(this.var_401 == null)
               {
                  this.var_1407 = this._scale + "_std_" + this.var_168 + "_" + this.var_1831 + "_" + _loc5_ + "_0";
                  this.var_401 = this._assets.getAssetByName(this.var_1407) as BitmapDataAsset;
               }
               if(!(!this.var_401 || !this.var_401.content))
               {
                  ...
                  {
                     this.var_1832 = this._structure.renderManager.paletteManager.getPalette(this.var_113.paletteMapId);
                     if(this.var_1832 != null)
                     {
                        this.var_921 = this.var_401.content as BitmapData;
                        this.var_167 = new BitmapData(this.var_921.width,this.var_921.height);
                        this.var_2575 = this.var_1832.colorize(this.var_921.getPixels(this.var_921.rect));
                        this.var_167.setPixels(this.var_167.rect,this.var_2575);
                     }
                     else
                     {
                        this.var_167 = (this.var_401.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1406 == AvatarBodyPartType.const_206 || this.var_1406 == AvatarBodyPartType.const_1337 || this.var_1406 == AvatarBodyPartType.const_1273) && this.var_113.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_167.colorTransform(this.var_167.rect,this.var_113.color.colorTransform);
                  }
                  if(this.var_113.isBlendable)
                  {
                     this.var_167.colorTransform(this.var_167.rect,this.var_113.blendTransform);
                  }
                  this.var_920 = this.var_401.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_46)
                     {
                  ...
                  this.var_2576 = new ImageData(this.var_167,this.var_920,_loc7_);
                  this.var_919.push(this.var_2576);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_919,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2574.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_46)
            {
         ...
         _loc8_ = this.var_919.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_919.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
