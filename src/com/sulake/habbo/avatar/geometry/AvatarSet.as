package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2582 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1145 = new Dictionary();
         this.var_1839 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1145[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_1839.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1839.concat();
         for each(_loc3_ in this.var_1145)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2581 = _loc6_;
      }
      ...
      public function findAvatarSet(param1:String) : AvatarSet
      {
         ...
         for each(_loc2_ in this.var_1145)
         {
      ...
      public function get isMain() : Boolean
      {
         ...
         for each(_loc1_ in this.var_1145)
         {
            if(_loc1_.isMain)
            {
               return true;
