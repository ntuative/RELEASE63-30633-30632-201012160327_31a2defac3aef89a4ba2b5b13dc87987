package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1829:String = "hd-99999-99999";
      ...
      private var var_1566:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_609 = RenderMode.const_1274;
         this.var_267 = new Map();
         this.var_92 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_102,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_92.add(AvatarType.const_102,_loc4_);
         _loc4_ = new AvatarStructure(this,AvatarType.const_61,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_92.add(AvatarType.const_61,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_92 != null)
         {
            for each(_loc1_ in this.var_92.getValues())
            {
               _loc1_.dispose();
            }
            this.var_92.dispose();
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_305.init();
         this.var_659.init();
         _loc2_ = this.var_92.getValue(AvatarType.const_102) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_92.getValue(AvatarType.const_61) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_92.getValue(AvatarType.const_102) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_861)
         {
            if(this.var_2146 && this.var_2145 && this.var_2147)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_92.getValue(AvatarType.const_102) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1566)
         {
            this.var_1566 = new AvatarFigureContainer(this.const_1829);
         }
         this.var_196.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1566,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_267 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_267.getKeys())
         {
            _loc4_ = this.var_267.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1491)
         {
            _loc6_ = !this.var_305.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_305.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_92.getValue(AvatarType.const_61) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_267.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_92.getValue(AvatarType.const_61);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_267.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_267.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_92.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_92.getValue(AvatarType.const_102) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_102:
               _loc3_ = this.var_92.getValue(AvatarType.const_102) as AvatarStructure;
               break;
            case AvatarType.const_61:
               _loc3_ = this.var_92.getValue(AvatarType.const_61) as AvatarStructure;
               break;
            default:
