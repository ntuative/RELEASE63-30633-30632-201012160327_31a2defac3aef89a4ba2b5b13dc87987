package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private var var_596:IItemGridWindow;
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this._view != null)
         {
            this.var_596 = this._view.findChildByName("part_thumbs") as IItemGridWindow;
            this.var_479 = new Array();
            this.var_479.push(this._view.findChildByName("palette0") as IItemGridWindow);
            this.var_479.push(this._view.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         this.var_596.removeGridItems();
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               this.var_596.addGridItem(_loc2_.view);
         ...
         while(_loc3_ < this.const_1142)
         {
            ...
            _loc5_ = this.var_479[_loc3_] as IItemGridWindow;
            if(!(!_loc4_ || !_loc5_))
            {
      ...
      {
         var _loc3_:IWindow = this.var_596.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_596.getGridItemIndex(param1.window);
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_38)
         {
            ...
            {
               if(this.var_479.length > _loc7_)
               {
                  _loc4_ = this.var_479[_loc7_] as IItemGridWindow;
