package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_831:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_744.width,this.var_744.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_744,this.var_744.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1049.width,this.var_1049.height,true,0);
            _loc5_ = this.var_1049.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_831.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_830.width,this.var_830.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_830,this.var_830.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_831)
            {
               switch(this.var_831.clubLevel)
               {
                  case HabboClubLevelEnum.const_49:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_58:
                     _loc4_.style = HabboIconType.const_561;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_50:
                     _loc4_.style = HabboIconType.const_607;
                     _loc4_.visible = true;
               }
            }
            else
