package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1216:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1311:XML;
      
      private static var var_1313:XML;
       
      
      private var var_1660:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2665:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1660 == 4294967295)
            {
               this.var_1660 = _loc1_.color;
            }
            _loc1_.color = const_1216;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1325;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1275;
            }
         }
      }
      ...
      {
         this.var_53 = navigator.catalog.windowManager.buildFromXML(var_1313) as IItemListWindow;
         if(this.var_53 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1311) as IWindowContainer;
         }
         else
         {
