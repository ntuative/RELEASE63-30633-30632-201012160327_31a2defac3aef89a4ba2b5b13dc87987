package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1132:String = "poster";
       
      
      public const const_1778:int = 1;
      
      public const const_1770:int = 2;
      
      public const const_1862:int = 3;
      ...
      private var var_2173:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_198)
         {
            for each(_loc1_ in this.var_198)
            {
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_195)
         {
            this.var_195 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_195.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2170,this.var_2171,this.var_2167,this.var_2166);
      }
      ...
      {
         if(!this.var_155 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_155.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_1778,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = this.var_198.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_198.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_497)
            {
               this.var_198.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         if(this.var_155)
         {
            for each(_loc5_ in this.var_155)
            {
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_155.add(_loc4_.offerId,_loc6_);
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         if(this.var_198)
         {
            for each(_loc5_ in this.var_198)
            {
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
         ...
         this.var_2172 = _loc3_.creditsWaiting;
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc6_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_198.add(_loc4_.offerId,_loc6_);
         }
         if(this._visualization == null)
         {
            return;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_155.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_155.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_155.add(parser.offerId,updateItem);
            }
            this.var_155.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_1770,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_198.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2165 || param1.furniTypeId != this.var_2168)
         {
            return;
         }
      ...
      private function isPosterItem(param1:MarketPlaceOfferData) : Boolean
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         ...
         {
            _loc3_ = this._catalog.getFurnitureData(param1.furniId,ProductTypeEnum.const_78);
            if(_loc3_)
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1132)
               {
                  _loc2_ = true;
               }
            }
      ...
      public function getNameLocalizationKey(param1:MarketPlaceOfferData) : String
      {
         var _loc2_:* = "";
         if(param1 != null)
         {
      ...
      public function getDescriptionLocalizationKey(param1:MarketPlaceOfferData) : String
      {
         var _loc2_:* = "";
         if(param1 != null)
         {
