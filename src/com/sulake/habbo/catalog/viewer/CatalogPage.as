package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1040:ICatalogViewer;
      ...
      private var var_1301:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1302:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1301 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1048);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1048);
      }
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_1891 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1891) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1302 = new ItemGridCatalogWidget(_loc1_);
            this.var_57.push(this.var_1302);
         }
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1498) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1261) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new SpacesCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1391) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1327) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1500) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new RecyclerPrizesCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1389) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new MarketPlaceCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1447) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new MarketPlaceOwnItemsCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1482) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1377) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1301;
            _loc2_.init();
         }
         this.var_1301.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1301.dispatchEvent(param1);
      }
   }
}
