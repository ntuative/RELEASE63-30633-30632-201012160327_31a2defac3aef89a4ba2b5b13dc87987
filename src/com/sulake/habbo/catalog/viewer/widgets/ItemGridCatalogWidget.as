package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_328:IGridItem;
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_845 == page.offers.length)
            {
         ...
         while(_loc3_ < 3)
         {
            if(this.var_845 >= 0 && this.var_845 < page.offers.length)
            {
               _loc4_ = page.offers[this.var_845];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_495)
         {
            ++this.var_1670;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1670);
         }
      }
