package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1060:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1060.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1059 != null)
         {
            this.var_1059.removeEventListener(WindowKeyboardEvent.const_142,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1060 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1060 != null)
         {
            this.var_1060.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1059 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1059 != null)
         {
            this.var_1059.addEventListener(WindowKeyboardEvent.const_142,this.windowKeyEventProcessor);
         }
      }
