package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1835 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1411.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_328 = null;
         for each(_loc1_ in this.var_1411)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1835) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(this.var_744.width,this.var_744.height,true,0);
               _loc3_.bitmap.copyPixels(this.var_744,this.var_744.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_1049.width,this.var_1049.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_830.width,this.var_830.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_830,this.var_830.rect,new Point(0,0),null,null,true);
