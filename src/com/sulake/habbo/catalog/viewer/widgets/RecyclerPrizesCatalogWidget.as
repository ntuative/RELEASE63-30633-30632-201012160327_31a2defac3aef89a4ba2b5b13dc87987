package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1040:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1623:XML;
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         this.var_1040 = new PrizeViewer();
         this.var_673 = this.recycler.getPrizeTable();
         ...
         if(this.var_673.length > 0 && this.var_673[0].prizes.length > 0)
         {
            this.select(this.var_673[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_673.length)
         {
            this.createLevelItem(this.var_673[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1624) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1623) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1040.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
