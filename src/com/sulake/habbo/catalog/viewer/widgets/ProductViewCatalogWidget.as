package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1773:BitmapData;
      ...
      private var var_1774:Point;
      
      private var var_481:IItemGridWindow;
      
      private var var_1387:IScrollbarWindow;
      
      protected var var_1623:XML;
      ...
      {
         this.var_906 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1120 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1774 = new Point(this.var_83.x,this.var_83.y);
         this.var_481 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1387 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_481 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1623 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         this.var_1773 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_906.text = _loc4_;
         this.var_1120.text = _loc5_;
         this.var_906.height = this.var_906.textHeight + 5;
         this.var_1120.y = this.var_906.y + this.var_906.height;
         this.var_1120.height = Math.max(130,this.var_1120.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_495:
                  _loc6_ = this.var_1773.clone();
                  if(this.var_481 != null)
                  {
                     this.var_481.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_481,this.var_1387,this.var_1623);
                     this.var_481.scrollV = 0;
                  }
                  break;
               ...
               case Offer.const_398:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_233:
                        ...
                        _loc6_ = new BitmapData(this.var_83.width,this.var_83.height,false,_loc13_);
                        _loc14_ = null;
                        _loc15_ = page.viewer.catalog as HabboCatalog;
                        if(_loc15_.avatarRenderManager != null)
                        {
                           _loc17_ = _loc15_.sessionDataManager.figure;
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_46);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_43,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_298,AvatarAction.const_489);
                              _loc16_.appendAction(AvatarAction.const_301,_loc8_.productClassId);
                              _loc16_.endActionAppends();
                              _loc16_.updateAnimationByFrames(1);
                              _loc16_.updateAnimationByFrames(1);
                              _loc14_ = _loc16_.getImage(AvatarSetType.const_32,true);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_83);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            if(this.var_83.bitmap == null)
            {
               this.var_83.bitmap = new BitmapData(this.var_83.width,this.var_83.height,true,16777215);
            }
            this.var_83.bitmap.fillRect(this.var_83.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_83.width - param1.width) / 2,(this.var_83.height - param1.height) / 2);
            this.var_83.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_83.invalidate();
            this.var_83.x = this.var_1774.x;
            this.var_83.y = this.var_1774.y;
            if(param3 != null)
            {
               this.var_83.x += param3.x;
               this.var_83.y += param3.y;
            }
         }
         if(param2)
         {
