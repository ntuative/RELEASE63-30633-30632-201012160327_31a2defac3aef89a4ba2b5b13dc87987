package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_828:int = 0;
      
      private static const const_385:int = 1;
      
      private static const const_827:int = 2;
      ...
      {
         return this.var_522 != const_828;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1490 != RecyclerStatusMessageEvent.const_1111;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_522 == const_385;
      }
      ...
      {
         this.var_522 = const_827;
         this.var_102 = new Array(const_174);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1490)
         {
            case RecyclerStatusMessageEvent.const_1426:
               this.var_522 = const_385;
               if(this._view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_1111:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1370:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_934:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1448:
      ...
      public function getSlotContent(param1:int) : FurniSlotItem
      {
         ...
         if(param1 >= this.var_102.length)
         {
            return null;
         }
         return this.var_102[param1];
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_102.length > 0)
         {
            oldObjectData = this.var_102[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_174)
            {
               oldObjectData = this.var_102[newSlotId];
         ...
         this.var_102[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_102[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_102[param1].id))
         {
            return;
         }
         this.var_102[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_102.length)
         {
            _loc3_ = this.var_102[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_102.length < const_174)
         {
            return false;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_102.length)
         {
            if(this.var_102[_loc1_] == null)
            {
               return false;
            }
            _loc1_++;
