package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_85:IPurchasableOffer;
      ...
      private var var_298:int = -1;
      
      private const const_1827:int = 10;
      ...
      private const const_1566:uint = 4.293848814E9;
      
      private const const_1565:uint = 4.294967295E9;
      
      private const const_1826:uint = 4.291613146E9;
      ...
      {
         if(this.var_85 == null || this.var_85.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_85.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_85.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_85 is Offer)
            {
               _loc10_ = this.var_85.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_85 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_78:
                  ...
                  break;
               case ProductTypeEnum.const_233:
      ...
      {
         var _loc1_:IProductData = this._catalog.getProductData(this.var_85.localizationId);
         ...
         var _loc3_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,this.var_85);
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1498 = _loc1_.stuffTypes;
            this.var_650 = _loc1_.boxTypes;
            this.var_649 = _loc1_.ribbonTypes;
            this.var_976 = this.var_1498[0];
            this.var_297 = this.var_650[0];
            this.var_299 = this.var_649[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_299 < 0)
         {
            this.var_299 = this.var_649.length - 1;
         }
         if(this.var_299 > this.var_649.length - 1)
         {
            this.var_299 = 0;
         }
         if(this.var_297 < 0)
         {
            this.var_297 = this.var_650.length - 1;
         }
         if(this.var_297 > this.var_650.length - 1)
         {
            this.var_297 = 0;
         }
         var _loc1_:int = this.var_650[this.var_297] * 1000 + this.var_649[this.var_299];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_85.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_976,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1233 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1498;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_84);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_976);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_650[this.var_297]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_649[this.var_299]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_85,this.var_1234,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_85.offerId,this.var_1234);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_115:
               ...
               if(this.var_2038 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_212)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1827)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2038 = _loc3_.text;
               break;
            case WindowMouseEvent.const_38:
               ...
               break;
            case WindowKeyboardEvent.const_676:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_298 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_298 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_298) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_532 == null)
         {
            this.var_532 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_532.procedure = this.suggestionsEventHandler;
         }
         if(this.var_222 == null || this.var_532 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_532.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_298) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_298);
         }
         this.var_298 = param1;
         if(this.var_298 < 0)
         {
            this.var_298 = _loc2_.numListItems - 1;
         }
         if(this.var_298 >= _loc2_.numListItems)
         {
            this.var_298 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_298) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1826;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1566) : uint(this.const_1565);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_976;
               }
            }
            _loc4_++;
         }
