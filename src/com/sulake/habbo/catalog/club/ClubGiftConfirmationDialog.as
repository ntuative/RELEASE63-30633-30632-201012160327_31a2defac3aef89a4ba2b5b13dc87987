package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         if(!this.var_85.productContainer)
         {
            return;
         }
         this.var_85.productContainer.view = _loc2_;
         this.var_85.productContainer.initProductIcon(this._controller.roomEngine);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this._controller.confirmSelection(this.var_85.localizationId);
               break;
