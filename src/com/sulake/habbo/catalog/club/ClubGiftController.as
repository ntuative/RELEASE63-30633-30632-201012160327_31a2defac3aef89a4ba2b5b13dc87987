package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftController
   {
      ...
      private var var_1802:Map;
      
      private var _catalog:HabboCatalog;
      
      private var var_195:ClubGiftConfirmationDialog;
      ...
      public function method_9(param1:int, param2:int, param3:Array, param4:Map) : void
      {
      ...
      public function selectGift(param1:Offer) : void
      {
         ...
         this.var_195 = new ClubGiftConfirmationDialog(this,param1);
      }
