package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_871:uint = 8;
      
      private static const const_1238:String = "skin";
      
      private static const const_1234:String = "bitmap";
      
      private static const const_1237:String = "fill";
      
      private static const const_1236:String = "text";
      
      private static const const_1233:String = "shape";
      
      private static const const_1232:String = "unknown";
      
      private static const const_1235:String = "PlaneMaterialCell";
      ...
      private var var_870:Dictionary;
      
      private var var_871:Dictionary;
      
      private var var_472:Dictionary;
      
      private var var_1722:Dictionary;
      
      private var var_2440:Dictionary;
      
      private var var_2439:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_870 = new Dictionary();
         this.var_871 = new Dictionary();
         this.var_1722 = new Dictionary();
         this.var_2440 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1722,this.var_2440);
         this.var_2439 = new Dictionary();
         this.var_2438 = new Dictionary();
         StateCodeTable.fillTables(this.var_2439,this.var_2438);
         this.var_472 = new Dictionary();
         this.var_472[const_1238] = BitmapSkinRenderer;
         this.var_472[const_1234] = BitmapDataRenderer;
         this.var_472[const_1237] = FillSkinRenderer;
         this.var_472[const_1236] = TextSkinRenderer;
         this.var_472[const_1233] = ShapeSkinRenderer;
         this.var_472[const_1232] = SkinRenderer;
         this.var_472[const_1235] = NullSkinRenderer;
         if(var_290 == null)
         {
            var_290 = new Array();
            var_290.push(WindowState.const_65);
            var_290.push(WindowState.const_70);
            var_290.push(WindowState.const_83);
            var_290.push(WindowState.const_48);
            var_290.push(WindowState.WINDOW_STATE_HOVERING);
            var_290.push(WindowState.const_76);
            var_290.push(WindowState.const_98);
            var_290.push(WindowState.const_90);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1722[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_870[param1] == null)
         {
            this.var_870[param1] = new Array(const_871);
         }
         this.var_870[param1][param2] = param3;
         if(this.var_871[param1] == null)
         {
            this.var_871[param1] = new Array(const_871);
         }
         this.var_871[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_870[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_274)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_871[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_274)
