package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1281:uint = 0;
      
      public static const const_716:uint = 1;
      
      public static const const_1097:uint = 2;
      
      public static const const_766:uint = 4;
      
      public static const const_1265:uint = 8;
      
      public static const const_1343:uint = 16;
      
      public static const const_1681:uint = 64;
      
      public static const const_1739:uint = 128;
      
      public static const const_1027:uint = 256;
      
      protected static var var_514:uint = 0;
      
      protected static var var_289:uint = 0;
       
      
      protected var var_186:DisplayObjectContainer;
      
      protected var var_1890:Boolean;
      
      protected var var_760:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_171:Shape;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1097:
               ...
               break;
            case GraphicContext.const_1265:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1343:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_766:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1027:
               break;
            case GraphicContext.const_1281:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_186.numChildren > 0)
               {
                  this.var_186.removeChildAt(0);
               }
            }
            this.var_186 = null;
            while(numChildren > 0)
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_171)
            {
               this.var_171 = new Shape();
               this.var_171.visible = false;
               this.var_171.cacheAsBitmap = true;
               super.addChild(this.var_171);
            }
            this.var_171.graphics.clear();
            this.var_171.graphics.beginFill(255);
            this.var_171.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_171.graphics.endFill();
            this.getDisplayObject().mask = this.var_171;
         }
         else if(this.var_171)
         {
            super.removeChild(this.var_171);
            this.var_171.graphics.clear();
            this.var_171 = null;
         ...
         if(this.var_760)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_289 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1890,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1890,16777215);
                  }
                  var_289 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_760)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_289 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_186 == null)
         {
            this.var_186 = new Sprite();
            this.var_186.name = this.name + " - Child Container";
            this.var_186.mouseEnabled = false;
            addChild(this.var_186);
         }
         return this.var_186;
      }
      ...
      {
         return this.var_186 != null ? int(this.var_186.numChildren) : 0;
      }
