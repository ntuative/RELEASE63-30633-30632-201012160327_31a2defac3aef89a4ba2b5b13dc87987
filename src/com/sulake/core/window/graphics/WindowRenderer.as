package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1671:Point;
      
      private var var_1322:Rectangle;
      
      private var var_275:Rectangle;
      
      private var var_824:ISkinContainer;
      
      private var var_318:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1671 = new Point();
         this.var_1322 = new Rectangle();
         this.var_275 = new Rectangle();
         this.var_318 = new Dictionary(true);
         this.var_824 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_688 = null;
            for(_loc1_ in this.var_318)
            {
               delete this.var_318[_loc1_];
            }
            this.var_318 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_275.x = param2.x - param1.x;
            this.var_275.y = param2.y - param1.y;
            this.var_275.width = param2.width;
            this.var_275.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_31))
            {
               while(param1.testParamFlag(WindowParam.const_31))
               {
                  ...
                  this.var_275.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_275,WindowRedrawFlag.const_888);
            if(this.var_688.indexOf(param1) == -1)
            {
               this.var_688.push(param1);
            }
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            this.addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_71);
         }
      }
      
      protected function getWindowRendererItem(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = this.var_318[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_318[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_824);
            this.var_318[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_750,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_750,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_318[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_318[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_688.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_688.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_275.x = _loc3_.dirty.x;
               this.var_275.y = _loc3_.dirty.y;
               this.var_275.width = _loc3_.dirty.width;
               this.var_275.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_275,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1671,this.var_1322))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1671,this.var_1322))
               {
                  ...
                  while(_loc8_ < _loc4_)
                  {
                     ...
                     else if(!_loc5_.testParamFlag(WindowParam.const_31))
                     {
            ...
            else if(!param1.testParamFlag(WindowParam.const_31))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1322);
