package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_416:Boolean = false;
      
      protected var var_217:uint = 16777215;
      
      protected var var_512:uint;
      
      protected var var_415:uint = 10;
      
      protected var var_767:Boolean = true;
      
      protected var var_350:Boolean = true;
      
      protected var var_626:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_79 = param4;
         this.var_768 = param8 == null ? new Array() : param8;
         this.var_16 = param6;
         this.var_11 = param7.clone();
         this.var_349 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this.var_16 = null;
            this._state = WindowState.const_515;
            this.var_768 = null;
         }
      }
      ...
      {
         return this.var_349.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_349.height;
      }
