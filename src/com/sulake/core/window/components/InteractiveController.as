package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1123:String = "tool_tip_caption";
      
      protected static const const_820:String = "";
      ...
      protected var var_2626:uint = 0;
      
      protected var var_408:Array;
      
      protected var var_1421:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_408[0] = MouseCursorType.const_315;
         this.var_408[1] = MouseCursorType.const_34;
         this.var_408[2] = MouseCursorType.const_315;
         this.var_408[3] = MouseCursorType.const_315;
         this.var_408[4] = MouseCursorType.const_34;
         this.var_408[5] = MouseCursorType.const_34;
         this.var_408[6] = MouseCursorType.const_315;
         if(var_257 == null)
         {
            var_257 = new Array();
            var_257[0] = WindowState.const_98;
            var_257[1] = WindowState.const_76;
            var_257[2] = WindowState.WINDOW_STATE_HOVERING;
            var_257[3] = WindowState.const_65;
            var_257[4] = WindowState.const_48;
      ...
      {
         if(param1.toolTipCaption != const_820)
         {
      ...
      {
         param2.push(new PropertyStruct(const_1123,param1.toolTipCaption,PropertyStruct.const_93,param1.toolTipCaption != const_820));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_279,param1.toolTipDelay != const_1529));
         return param2;
      }
      ...
      {
         this.var_1166 = param1 == null ? const_820 : param1;
      }
