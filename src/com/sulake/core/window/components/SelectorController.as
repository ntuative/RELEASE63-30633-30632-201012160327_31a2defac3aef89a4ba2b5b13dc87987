package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_182:ISelectableWindow;
      
      protected var var_1896:Boolean = true;
      ...
      {
         return this.var_182 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_182)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_321,this,this.var_182));
               }
            }
         }
      }
