package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1240:String = "_SELECTOR";
      
      private static const const_1239:String = "_CONTENT";
       
      
      protected var var_939:ITabSelectorWindow;
      
      protected var var_1895:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_939 = findChildByTag(const_1240) as ITabSelectorWindow;
            if(this.var_939 != null)
            {
               this.var_939.procedure = this.selectorEventProc;
            }
         }
         return this.var_939;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1895 = findChildByTag(const_1239) as IWindowContainer;
         }
      ...
      {
         return !!this.var_666 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_939.numSelectables;
      }
