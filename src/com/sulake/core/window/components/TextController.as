package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1129:Dictionary = createPropertySetterTable();
      
      protected static const ZERO_RECT:Rectangle = new Rectangle();
      
      protected static const const_1536:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1534:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1535:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
       
      
      protected var _field:TextField;
      
      protected var var_765:Number;
      
      protected var var_509:Number;
      
      protected var var_510:Boolean;
      
      protected var var_78:TextMargins;
      
      protected var var_410:String = "none";
      
      protected var var_511:Boolean = false;
      
      private var var_1338:Boolean = false;
      
      private var var_374:String = "regular";
      
      private var var_206:TextStyle;
      ...
      {
         this.var_206 = new TextStyle();
         this.var_78 = new TextMargins(0,0,0,0,this.setTextMargins);
         this.var_510 = false;
         this.var_765 = 0;
         this.var_509 = 0;
         if(this._field == null)
         ...
         setTextFormatting(this._field,this.var_374,this.var_206);
      ...
      private static function setAntiAliasType(param1:TextController, param2:String) : void
      {
         ...
         param1.var_206.antiAliasType = param2;
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.var_206.fontWeight = TextStyle.BOLD;
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_206.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_206.fontSize = param2;
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_206.fontStyle = !!param2 ? "null" : TextStyle.NORMAL;
      }
      ...
      private static function setKerning(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_206.kerning = param2;
      }
      
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         param1.var_78.dispose();
         param1.var_78 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc4_);
         param1.defaultTextFormat = _loc3_;
         param1.var_206.letterSpacing = param2;
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_374 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_374,param1.var_206);
            param1.refreshTextImage();
         }
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_206.textDecoration = !!param2 ? "null" : TextStyle.NONE;
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_333);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_1042 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_374);
      }
      ...
      {
         this.var_765 = param1;
         this._field.scrollH = this.var_765 * Number(this._field.maxScrollH);
         this.refreshTextImage();
      }
      
      public function set scrollV(param1:Number) : void
      {
         if(param1 > this.var_509)
         {
            this.var_509 = param1;
            this._field.scrollV = Math.max(this._field.scrollV,param1 * this._field.maxScrollV + 1);
            this.refreshTextImage();
         }
         else if(param1 < this.var_509)
         {
            this.var_509 = param1;
      ...
      {
         return new Rectangle(this.var_765 * this.maxScrollH,this.var_509 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_765 = this.var_765;
         _loc1_.var_509 = this.var_509;
         _loc1_.var_78 = this.var_78.clone(_loc1_.setTextMargins);
         _loc1_.var_410 = this.var_410;
         _loc1_.var_511 = this.var_511;
         return _loc1_;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_510)
         {
            if(param2.type == WindowNotifyEvent.const_167)
            {
               this.refreshTextImage();
            }
         }
      ...
      protected function refreshTextImage() : void
      {
         ...
         this.var_510 = true;
         var _loc1_:int = this.var_78.left + this.var_78.right;
         var _loc2_:int = this.var_78.top + this.var_78.bottom;
         ...
         if(_loc5_ != _loc3_)
         {
            if(this.var_410 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_410 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
            else if(this.var_410 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(this.var_410 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_11.x,var_11.y,_loc5_ + _loc1_,Math.floor(this._field.height) + _loc2_);
               _loc6_ = true;
            }
      ...
      {
         if(param1 != this.var_78)
         {
            this.var_78.dispose();
            this.var_78 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,this.setTextMargins);
         }
         this.refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_374);
         _loc1_.push(new PropertyStruct("font_face",this.defaultTextFormat.font,PropertyStruct.const_93,this.defaultTextFormat.font != _loc2_.fontFamily));
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_279,this.defaultTextFormat.size != _loc2_.fontSize));
         ...
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_93,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1536));
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_51,this._field.alwaysShowSelection != false));
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_51,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_169,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_51,this._field.condenseWhite != false));
         _loc1_.push(new PropertyStruct("display_as_password",this._field.displayAsPassword,PropertyStruct.const_51,this._field.displayAsPassword != false));
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_93,this._field.gridFitType != GridFitType.PIXEL,const_1534));
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_52,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",this._field.mouseWheelEnabled,PropertyStruct.const_51,this._field.mouseWheelEnabled != false));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_51,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_93,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_236,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("text_style",this.var_374,PropertyStruct.const_93,this.var_374 != TextStyleManager.const_333,STYLE_SHEET_RANGE));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_236,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_51,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_78.left,PropertyStruct.const_52,this.var_78.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_78.top,PropertyStruct.const_52,this.var_78.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_78.right,PropertyStruct.const_52,this.var_78.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_78.bottom,PropertyStruct.const_52,this.var_78.bottom != 0));
         _loc1_.push(new PropertyStruct("auto_size",this.var_410,PropertyStruct.const_93,this.var_410 != TextFieldAutoSize.NONE,const_1535));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_51,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_51,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_51,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_51,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_236,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
