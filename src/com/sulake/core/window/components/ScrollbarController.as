package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1160:String = "increment";
      
      private static const const_1161:String = "decrement";
      
      private static const const_834:String = "slider_track";
      
      private static const const_544:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_151 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_502;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_467,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_45,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_467,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_783 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_834) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_544) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_544:
               if(param2.type == WindowNotifyEvent.const_268)
               {
                  if(!this.var_977)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowNotifyEvent.const_541)
         {
            if(this.var_19 == null)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_38 || param1.type == WindowTouchEvent.const_400)
         {
            ...
            else if(param2.name == const_1161)
            {
               if(this.var_19)
               {
                  this.var_977 = true;
            ...
            else if(param2.name == const_834)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_544).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_783) as IScrollableWindow;
            if(_loc1_ == null && var_13 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_13).findChildByName(this.var_783) as IScrollableWindow;
               if(_loc1_)
               {
