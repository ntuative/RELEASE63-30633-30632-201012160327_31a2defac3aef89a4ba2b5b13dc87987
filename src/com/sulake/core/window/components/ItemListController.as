package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1121:String = "spacing";
      
      protected static const const_1122:String = "scale_to_fit_items";
      
      protected static const const_1119:String = "resize_on_item_update";
      
      protected static const const_1120:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1527:Boolean = false;
      ...
      protected var var_1885:Boolean = false;
      
      protected var var_504:Boolean = false;
      ...
      protected var var_934:Boolean = true;
      
      protected var var_505:Boolean = false;
      
      protected var var_1163:Boolean = false;
      
      protected var var_1884:int = 0;
      
      protected var var_1883:int = 0;
      
      protected var var_1162:Number;
      
      protected var var_1164:Number;
      
      protected var var_1161:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_98 = 0;
         this.var_90 = 0;
         this._horizontal = param2 == WindowType.const_346;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_151 = var_416 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_381,WindowStyle.const_587,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_275,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_620 * this.maxScrollH,this.var_619 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_619 = param1;
            this._container.y = -this.var_619 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_71);
            dispatchEvent(new WindowEvent(WindowEvent.const_467,this,null));
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_275,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_38:
               this.var_1884 = _loc3_;
               this.var_1883 = _loc4_;
               this.var_1162 = 0;
               this.var_1164 = 0;
               this.var_1161 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_183:
               if(this.var_1161)
               {
                  this.var_1162 = this.var_1884 - _loc3_;
                  this.var_1164 = this.var_1883 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1164 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1164 / this.var_90;
                  }
                  this.var_1884 = _loc3_;
                  this.var_1883 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_184:
               if(this.var_1161)
               {
                  ...
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1164);
                  }
                  this.var_1161 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_934 && !this.var_504 && this._container)
         {
            this.var_504 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1121,this._spacing,PropertyStruct.const_52,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1120,this.var_934,PropertyStruct.const_51,this.var_934 != const_1528));
         _loc1_.push(new PropertyStruct(const_1122,this.var_505,PropertyStruct.const_51,this.var_505 != const_1527));
         _loc1_.push(new PropertyStruct(const_1119,this.var_1163,PropertyStruct.const_51,this.var_1163 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1119:
                  ...
                  break;
               case const_1120:
                  this.var_934 = _loc2_.value as Boolean;
                  break;
            }
         }
