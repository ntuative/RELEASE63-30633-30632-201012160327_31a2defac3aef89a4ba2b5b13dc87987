package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_949:IItemListWindow;
      
      private var var_353:IScrollbarWindow;
      
      private var var_1448:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_70))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_353)
         {
            this.var_353.removeEventListener(WindowEvent.const_297,this.scrollBarEventProc);
            this.var_353.removeEventListener(WindowEvent.const_252,this.scrollBarEventProc);
            this.var_353 = null;
         }
         if(this.var_949)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_949)
         {
            this.var_949 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return this.var_949;
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_353)
         {
            this.var_353 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_353)
            {
               this.var_353.addEventListener(WindowEvent.const_297,this.scrollBarEventProc);
               this.var_353.addEventListener(WindowEvent.const_252,this.scrollBarEventProc);
            }
         }
         return this.var_353;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_252)
         {
            this.hideScrollBar();
         }
      }
