package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1167:String = "_TITLE";
      
      private static const const_1166:String = "_HEADER";
      
      private static const const_1169:String = "_CONTENT";
      
      private static const const_1168:String = "_SCALER";
      
      private static const const_838:String = "margin_left";
      
      private static const const_836:String = "margin_top";
      
      private static const const_835:String = "margin_right";
      
      private static const const_837:String = "margin_bottom";
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1167) as ITextWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1247 = findChildByTag(const_1166) as IHeaderWindow;
            if(!this.var_1247)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_152 = findChildByTag(const_1169) as IWindowContainer;
            if(!this.var_152)
            {
      ...
      {
         return findChildByTag(const_1168) as IScalerWindow;
      }
      ...
      public function get margins() : IMargins
      {
         ...
         if(!this.var_78)
         {
            ...
            this.var_78 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,this.marginsCallback);
         }
         return this.var_78;
      }
      ...
      {
         return this.content != null && this.var_938 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_296);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_270,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:* = this.var_78 != null;
         var _loc3_:Rectangle = this.content.rectangle;
         _loc1_.push(new PropertyStruct(const_838,_loc3_.left,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_836,_loc3_.top,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_835,0 - _loc3_.right,PropertyStruct.const_52,_loc2_));
         _loc1_.push(new PropertyStruct(const_837,0 - _loc3_.bottom,PropertyStruct.const_52,_loc2_));
         return _loc1_;
      }
