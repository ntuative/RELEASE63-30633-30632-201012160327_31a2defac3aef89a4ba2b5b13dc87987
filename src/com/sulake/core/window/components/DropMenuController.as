package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_382:String = "_DROPMENU_TITLETEXT";
      
      protected static const const_1127:String = "_DROPMENU_ITEMLIST";
      
      protected static const const_1128:String = "item_array";
       
      
      private var _itemArray:Array;
      
      private var var_578:int = -1;
      
      private var var_853:Boolean = false;
      
      private var var_157:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_433,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_578 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_321,this,null));
         }
      }
      ...
      {
         if(this.var_157 != null && !this.var_157.disposed)
         {
            this.var_157.destroy();
            this.var_157 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_382) as ITextWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_157 == null || this.var_157.disposed)
         {
            this.var_157 = context.create(name + "::submenu","",WindowType.const_450,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_157.setGlobalRectangle(_loc1_);
         }
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1127) as IItemListWindow;
         if(_loc3_ != null)
         {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_157.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_853 = false;
            this.getTitleText().text = this.var_578 < this._itemArray.length && this.var_578 > -1 ? this._itemArray[this.var_578] : caption;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1127) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_411,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_381,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_578 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_578).setStateFlag(WindowState.const_48,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_54:
               ...
               break;
            case WindowTouchEvent.const_638:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1083,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1128,this._itemArray,PropertyStruct.const_149,this._itemArray.length > 0));
         return _loc1_;
      }
