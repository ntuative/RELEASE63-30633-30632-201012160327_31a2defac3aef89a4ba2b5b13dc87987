package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_333:String = "regular";
      ...
      private static var var_214:IEventDispatcher;
      
      private static const TAG_OPEN:String = "{";
      
      private static const const_547:String = "}";
      
      private static const const_1180:String = "/*";
      
      private static const const_1181:String = "*/";
      ...
      private static function init() : void
      {
         var _loc1_:* = null;
         var_82 = new Map();
         var_214 = new EventDispatcher();
         _loc1_ = new TextStyle();
         _loc1_.name = const_333;
         _loc1_.color = 0;
         _loc1_.fontSize = "9";
      ...
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            var_214.dispatchEvent(new Event(Event.ADDED));
         }
         else
         {
            var_214.dispatchEvent(new Event(Event.CHANGE));
         }
      }
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_333],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_333] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_547);
         if(countSubStrings(param1,TAG_OPEN) != countSubStrings(param1,const_547))
         {
            throw new Error("Mismatching amount of \"" + TAG_OPEN + "\" versus \"" + const_547 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1180) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1181) + 2,_loc5_.length);
            }
