package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_129 = param1.desktop;
         this.var_77 = param1.var_1158 as WindowController;
         this._lastClickTarget = param1.var_1156 as WindowController;
         this.var_150 = param1.renderer;
         this.var_758 = param1.var_1157;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_621.x || _loc3_.stageY != this.var_621.y)
            {
               this.var_621.x = _loc3_.stageX;
               this.var_621.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_129.groupParameterFilteredChildrenUnderPoint(this.var_621,_loc6_,WindowParam.const_28);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_77 != this.var_129 && !this.var_77.disposed)
                  {
                     this.var_77.getGlobalPosition(_loc7_);
                     this.var_77.update(this.var_77,new WindowMouseEvent(WindowMouseEvent.const_25,this.var_77,null,_loc3_.stageX - _loc7_.x,_loc3_.stageY - _loc7_.y,_loc3_.stageX,_loc3_.stageY,_loc3_.altKey,_loc3_.ctrlKey,_loc3_.shiftKey,_loc3_.buttonDown,_loc3_.delta));
                     this.var_77 = WindowController(this.var_129);
                  }
               }
            }
            while(--_loc4_ > -1)
            {
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  if(_loc3_.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(_loc5_ != this.var_77)
                     {
                        if(!this.var_77.disposed)
                        {
                           this.var_77.getGlobalPosition(_loc7_);
                           this.var_77.update(this.var_77,new WindowMouseEvent(WindowMouseEvent.const_25,this.var_77,_loc5_,_loc3_.stageX - _loc7_.x,_loc3_.stageY - _loc7_.y,_loc3_.stageX,_loc3_.stageY,_loc3_.altKey,_loc3_.ctrlKey,_loc3_.shiftKey,_loc3_.buttonDown,_loc3_.delta));
                        }
                        if(!_loc5_.disposed)
                        {
                  ...
                  {
                     if(this.var_77 && !this.var_77.disposed)
                     {
                        if(this.var_758 != null)
                        {
                           this.var_758.mouseEventReceived(_loc3_.type,this.var_77);
                        }
                     }
                  }
                  ...
                  if(_loc3_.altKey)
                  {
                     if(this.var_77)
                     {
                        Logger.log("HOVER: " + this.var_77.name);
                     }
                  }
                  if(_loc5_ != this.var_129)
                  {
         ...
         param2.end();
         param1.desktop = this.var_129;
         param1.var_1158 = this.var_77;
         param1.var_1156 = this._lastClickTarget;
         param1.renderer = this.var_150;
         param1.var_1157 = this.var_758;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_516))
         {
