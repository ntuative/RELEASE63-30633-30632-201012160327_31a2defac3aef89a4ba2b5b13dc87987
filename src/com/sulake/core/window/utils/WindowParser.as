package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_927:String = "_EXCLUDE";
      
      public static const const_1696:String = "_INCLUDE";
      
      public static const const_1656:String = "_TEMP";
      
      private static const const_1220:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1219:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var _typeStringToCodeTable:Dictionary;
      
      protected var var_1176:Dictionary;
      
      protected var var_936:Dictionary;
      
      protected var var_1426:Dictionary;
      
      protected var var_1892:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1176 = new Dictionary();
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1176);
         this.var_936 = new Dictionary();
         this.var_1426 = new Dictionary();
         ParamCodeTable.fillTables(this.var_936,this.var_1426);
         this.var_1892 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1219,"");
         return param1.replace(const_1220,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1176)
            {
               delete this.var_1176[_loc1_];
            }
            for(_loc1_ in this.var_936)
            {
               delete this.var_936[_loc1_];
            }
            for(_loc1_ in this.var_1426)
            {
               delete this.var_1426[_loc1_];
            }
            this.var_1892.dispose();
            this.var_1892 = null;
            this.var_16 = null;
            this._disposed = true;
         }
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_185)
                     {
                        window.x = rect.x;
                     }
                     if((params & 0) == WindowParam.const_161)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1176[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_927) == -1)
                  {
