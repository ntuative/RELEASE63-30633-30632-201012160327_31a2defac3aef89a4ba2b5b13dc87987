package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1237:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1236:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_136:IProfiler;
      ...
      {
         super();
         this.var_23 = param1 as ICore;
         this.var_2649 = new Array();
         this.var_136 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1237() as ByteArray;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(value != this.visible)
         {
            ...
            if(value)
            {
               ...
               this.var_23.setProfilerMode(true);
               this.var_23.queueInterface(new IIDProfiler(),function(param1:IID, param2:IUnknown):void
               {
            ...
            {
               this.var_23.setProfilerMode(false);
            }
         }
      }
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_136)
         {
            this.var_136.removeStopEventListener(this.refresh);
            this.var_136 = null;
         }
         if(!this.var_136 && param1)
         {
            this.var_136 = param1;
            this.var_136.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_650)
            {
               this.var_1516 = false;
               ITextWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_136.getProfilerAgentsInArray();
         ...
         if(this.var_1516)
         {
            ITextWindow(this._window.findChildByName("footer")).text = "Assets - Libraries: " + this.var_136.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_136.numBitmapAssetInstances + " / " + this.var_136.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_136.numTrackedBitmapDataInstances + " / " + this.var_136.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1236() as ByteArray;
