package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1532:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1299:Point = new Point();
      ...
      protected var var_762:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_626 = _loc13_.blend;
            var_415 = _loc13_.treshold;
            if(var_416 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_217 != _loc13_.color)
            {
      ...
      {
         return this.var_762 != null ? this.var_762 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_416 = param1;
         var_217 = !!var_416 ? uint(var_217 | var_512) : uint(var_217 & 16777215);
      ...
      {
         var_512 = param1 & 4278190080;
         var_217 = !!var_416 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      ...
      {
         var_512 = param1 << 24;
         var_217 = !!var_416 ? uint(var_512 | var_217) : uint(16777215 & var_217);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      
      public function set blend(param1:Number) : void
      {
         var_626 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1104);
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_79 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_441,this,null));
         }
      }
      ...
      {
         var_415 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_312 = this.var_13.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_541,this,this.var_13));
            }
            else
            {
               this.var_312.x = 0;
               this.var_312.y = 0;
               this.var_312.width = 0;
               this.var_312.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1039,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_716,var_11);
            this.var_21.visible = var_350;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_20,var_16,var_11,null,this.var_762,this.properties,var_768.concat(),_id) as WindowController;
         _loc2_.var_415 = var_415;
         _loc2_.var_151 = this.var_151;
         _loc2_._debug = this._debug;
         _loc2_.var_312 = this.var_312.clone();
         ...
         _loc2_.var_217 = var_217;
         _loc2_.var_512 = var_512;
         _loc2_.var_767 = var_767;
         _loc2_.var_350 = var_350;
         _loc2_.var_626 = var_626;
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_98))
                  {
                     this.deactivate();
                  }
               }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2264 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_16.invalidate(this,param1,WindowRedrawFlag.const_71);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_539)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_525)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_20 & 0);
            if(_loc7_ == WindowParam.const_409)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1094,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_674,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_505,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_167,this,null));
            }
         }
      }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_38:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1072;
                  if(testParamFlag(WindowParam.const_370))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_217))
                        {
               ...
               case WindowMouseEvent.const_54:
                  ...
                  if(testParamFlag(WindowParam.const_217))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_167:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_395,this,null));
                     if(testParamFlag(WindowParam.const_185,WindowParam.const_152))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_161,WindowParam.const_150))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
                     {
                        _loc9_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_491))
                        {
               ...
               case WindowNotifyEvent.const_505:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_518);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1098,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_268,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_378:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_709,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_250,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_487:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_999);
                  break;
               case WindowNotifyEvent.const_441:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1532) == -1)
                     {
                        _loc8_.style = var_79;
                     }
                  }
               ...
               case WindowNotifyEvent.const_459:
                  if(!(var_20 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_518);
                     }
                  }
                  else if(var_20 & 0)
                  {
                  ...
                  break;
               case WindowNotifyEvent.const_541:
                  if(testParamFlag(WindowParam.const_185,WindowParam.const_152))
                  {
                     this.updateScaleRelativeToParent();
                  }
               ...
               case WindowNotifyEvent.const_395:
                  this.var_13.getRegionProperties(null,this.var_312);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_355:
               ...
               case WindowNotifyEvent.const_268:
                  ...
                  break;
               case WindowNotifyEvent.const_566:
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_971:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1301:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_433:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_321:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_805:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_588:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_648:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_983:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_762:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_995:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1049:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_250:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1098:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_268:
               _loc2_ = "null";
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_415);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_415);
      }
         ...
         if(this.var_151 && var_415 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1299,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1299,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_136,WindowParam.const_152);
         var _loc2_:* = !testParamFlag(WindowParam.const_135,WindowParam.const_150);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_312.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.WINDOW_PARAM_RELATIVE_HORIZONTAL_SCALE_STRECH)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_361)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_185)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_312.height;
               _loc5_ = uint(var_20 & 0);
      ...
      {
         if(_state == WindowState.const_515)
         {
            return true;
         }
         _state = WindowState.const_515;
         ...
         _loc1_.type = WindowNotifyEvent.const_981;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_65,true);
      ...
      public function restore() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_65,false);
         _loc1_.type = WindowNotifyEvent.const_974;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_378;
         this.update(this,_loc1_);
         return true;
      }
      ...
      {
         if(this.getStateFlag(WindowState.const_65))
         {
            return true;
         }
         ...
         this.setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_1049;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_648;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_983,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_762;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1004;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_972;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1298 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_355,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1298 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_566,this,param1));
         return param1;
      }
