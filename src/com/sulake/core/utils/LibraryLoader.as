package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1540:uint = 1;
      
      protected static const const_1538:uint = 2;
      
      protected static const const_1539:uint = 4;
      
      protected static const const_1537:uint = 3;
      ...
      public static const const_940:Boolean = false;
      
      public static const const_1336:int = 2;
      
      private static var var_866:Array = new Array();
      
      private static var var_705:Array = new Array();
      ...
      protected var var_215:URLRequest;
      
      protected var var_699:XML;
      
      protected var var_579:Class;
      ...
      protected var var_2628:String = "";
      
      protected var var_2629:String = "";
      
      protected var var_1893:int;
      
      protected var var_1178:int;
      
      protected var var_1177:int;
      
      protected var var_2711:uint = 0;
      
      protected var var_2630:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_36.load(param1.var_215,param1.var_16);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_940)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_705[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_705.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_705.length < const_1336 && false)
            {
               _loc1_ = var_866.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_705.push(_loc1_);
                  _loc1_.var_36.load(_loc1_.var_215,_loc1_.var_16);
               }
            }
         }
      }
      ...
      {
         return !!this.var_215 ? this.var_215.url : null;
      }
      ...
      {
         return !!this.var_938 ? uint(this.var_1178 - this.var_1893) : uint(getTimer() - this.var_1893);
      }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_215.url);
      ...
      {
         if(this.var_937 && !_disposed)
         {
            this.var_937 = false;
            if(!this.var_938 && this.var_215)
            {
               this.var_1178 = -1;
               this.var_1893 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_938 && !_disposed && this.var_1177 > 0)
         {
            try
            {
               this.var_36.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_215,const_1413 - this.var_1177);
            if(this.var_2630)
            {
               this.var_215.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_215.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2630 = false;
            }
            --this.var_1177;
            this.var_412 = 0;
            this.var_36.load(this.var_215,this.var_16);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_412 = LibraryLoader.name_2;
         ...
         if(this.var_412 == LibraryLoader.const_1537)
         {
         ...
         if(this.var_412 == LibraryLoader.name_2)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_579 = this.getDefinition(this._name) as Class;
         if(this.var_579 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_215.url + "!");
            }
            return false;
         }
         try
         {
            xmlClass = this.var_579.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_699 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
