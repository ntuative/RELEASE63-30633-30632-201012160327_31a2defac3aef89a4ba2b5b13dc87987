package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1019:String = "AssetLibraryReady";
      
      public static const const_654:String = "AssetLibraryLoaded";
      
      public static const const_1385:String = "AssetLibraryUnloaded";
      
      public static const const_1356:String = "AssetLibraryLoadError";
      
      private static var var_278:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_461:uint = 0;
      
      private static var var_862:Array = new Array();
      ...
      private var var_579:Class;
      
      private var var_859:Dictionary;
      
      private var var_147:Dictionary;
      
      private var var_860:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_699 = new XML();
         this.var_377 = 0;
         this.var_376 = new Array();
         if(var_278 == null)
         {
            var_278 = new Dictionary(false);
         ...
         ++var_461;
         this.var_375 = new Dictionary(false);
         this.var_460 = new Dictionary(false);
         this.var_859 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_862.splice(var_862.indexOf(this),1);
            --var_461;
            this.var_460 = null;
            this.var_859 = null;
            this.var_147 = null;
      ...
      {
         if(this._file == param1.url && this.var_861)
         {
            if(!this.var_860 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_699,this.var_579);
            }
            this.var_860 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1019));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_460)
         {
            _loc2_ = this.var_460[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_460[_loc1_];
         }
         for(_loc1_ in this.var_147)
         {
            delete this.var_147[_loc1_];
         }
         for(_loc1_ in this.var_859)
         {
            delete this.var_859[_loc1_];
         }
         if(this.var_36 != null)
         {
            this.var_36.dispose();
         ...
         this.var_861 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1385));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_859[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_460[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1056,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_897,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_956,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_460[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_460[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_377;
                     this.var_376.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_460[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_376.length ? this.getAssetByName(this.var_376[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_147)
         {
            ...
            {
               return this.var_376.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_147[param1] != null || (this.var_579 != null ? this.var_579[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_278.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_278[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_375.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_375[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_278[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_375[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_278)
            {
               _loc3_ = AssetTypeDeclaration(var_278[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_375)
         {
            _loc3_ = AssetTypeDeclaration(this.var_375[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_278)
            {
               _loc4_ = AssetTypeDeclaration(var_278[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_375)
         {
            _loc4_ = AssetTypeDeclaration(this.var_375[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_699 = _loc2_.manifest.copy();
         this.var_579 = _loc2_.resource;
         ...
         this.var_861 = true;
         dispatchEvent(new Event(AssetLibrary.const_654));
         dispatchEvent(new Event(AssetLibrary.const_1019));
         if(this.var_860)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1356));
         this.var_36 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_699.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_579[param1]);
