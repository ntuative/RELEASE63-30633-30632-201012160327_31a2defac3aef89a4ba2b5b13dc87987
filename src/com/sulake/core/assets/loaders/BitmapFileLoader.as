package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_933 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_36 = new Loader();
         this.var_935 = new LoaderContext();
         this.var_935.checkPolicyFile = true;
         ...
         {
            this.var_36.load(param2,this.var_935);
         }
      }
      ...
      {
         this.var_933 = param1.url;
         var_288 = 0;
         this.var_36.load(param1,this.var_935);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_288 < var_2634)
            {
               ...
               this.var_36.load(new URLRequest(this.var_933 + (this.var_933.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_288),this.var_935);
               return true;
            }
         }
         return false;
