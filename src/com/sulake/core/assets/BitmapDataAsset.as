package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_468:uint = 0;
       
      
      private var _disposed:Boolean = false;
      
      private var var_107:Object;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_468 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      {
         var _loc1_:* = null;
         if(this.var_107 is Class)
         {
            _loc1_ = new this.var_107() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_107() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
         ...
         if(this.var_107 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_107).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_107 is BitmapData)
         {
            this._bitmap = this.var_107 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
         ...
         if(this.var_107 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_107)._bitmap;
            this._offset = BitmapDataAsset(this.var_107)._offset;
            this.var_1265 = BitmapDataAsset(this.var_107).var_1265;
            this.var_1266 = BitmapDataAsset(this.var_107).var_1266;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1265 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1266 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
