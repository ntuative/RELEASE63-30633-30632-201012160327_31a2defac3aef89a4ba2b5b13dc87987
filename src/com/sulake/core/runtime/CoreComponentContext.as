package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1151:String = "asset-libraries";
      
      private static const const_1154:String = "library";
      
      private static const const_1157:String = "service-libraries";
      
      private static const const_1159:String = "library";
      
      private static const const_1158:String = "component-libraries";
      
      private static const const_1152:String = "library";
      
      private static const const_1155:String = "error_data";
      
      private static const const_1156:String = "error_cat";
      
      private static const const_1153:String = "error_desc";
       
      
      private var var_296:LibraryLoaderQueue;
      
      private var var_648:IEventDispatcher;
      
      private var var_426:uint;
      
      private var var_427:Function;
      
      private var var_221:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         this.var_531 = new Array();
         var_413 = param1;
         var _loc3_:int = 0;
         while(_loc3_ < CoreComponentContext.const_140)
         {
            this.var_428.push(new Array());
            this.var_531.push(0);
            _loc3_++;
         }
         this.var_1512 = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_413.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1113:
               debug("Core; using simple frame update handler");
               this.var_427 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_745:
               debug("Core; using complex frame update handler");
               this.var_427 = this.complexFrameUpdateHandler;
               break;
            case Core.const_1518:
               debug("Core; using profiler frame update handler");
               this.var_427 = this.profilerFrameUpdateHandler;
               this.var_221 = new Profiler(this);
               attachComponent(this.var_221,[new IIDProfiler()]);
               var_413.addChild(new ProfilerViewer(this.var_221));
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_427 = this.debugFrameUpdateHandler;
         }
      }
      
      public function getNumberOfFilesPending() : uint
      {
         return this.var_296.length;
      }
      
      public function getNumberOfFilesLoaded() : uint
      {
         return this.var_426 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponentContext.const_140)
            {
               _loc2_ = this.var_428[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1155,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1156,String(param3));
         ErrorReportStorage.setParameter(const_1153,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_648 = loadingEventDelegate;
         if(this.var_296 == null)
         {
            this.var_296 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1151)[0];
            if(node != null)
            {
               list = node.child(const_1154);
         ...
         try
         {
            node = config.child(const_1158)[0];
            if(node != null)
            {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_648)
         {
            this.var_648.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_648)
         {
            ...
            this.var_648.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_648)
                  {
                     this.var_648.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_426 - this.var_296.length,this.var_426,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_428[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_428[_loc4_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_427(_loc2_,_loc2_ - this.var_1512);
         this.var_1512 = _loc2_;
      }
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_531[criticality] = 0;
            receivers = this.var_428[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(criticality < CoreComponentContext.const_140)
         {
            ...
            {
               if(this.var_531[criticality] < criticality)
               {
                  ++this.var_531[criticality];
                  skip = true;
               }
            }
            if(!skip)
         ...
         while(criticality < CoreComponentContext.const_140)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_221.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_221)
            {
               detachComponent(this.var_221);
               this.var_221.dispose();
               this.var_221 = null;
            }
            switch(this.var_1422 & 0)
            {
               case Core.const_1113:
                  this.var_427 = this.simpleFrameUpdateHandler;
                  break;
