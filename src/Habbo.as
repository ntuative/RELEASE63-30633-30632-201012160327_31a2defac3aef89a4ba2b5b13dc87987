package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_19:String = "client.init.start";
      ...
      public static const const_17:String = "crash_time";
      
      public static const const_20:String = "error_ctx";
      
      public static const const_14:String = "flash_version";
      ...
      public static const const_8:String = "fileBarSprite";
      ...
      public function Habbo()
      {
         ...
         this.var_7 = this.const_11[int(Math.random() * (this.const_11.length - 1))];
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_17] = new Date().getTime().toString();
            _loc7_ = "";
            _loc6_[const_20] = _loc7_;
            _loc6_[const_14] = Capabilities.version;
            _loc6_[const_15] = 0;
      ...
      {
         trackLoginStep(const_7);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + this.var_8,const_9,null);
      }
      ...
      private function onVisualizationUpdate(param1:Event) : void
      {
         if(this.var_2)
         {
            if(this.var_4 >= this.var_7.length)
            {
               this.var_4 = 0;
            }
            this.var_2.text = this.var_5 + "" + this.var_7[this.var_4];
            ++this.var_4;
         }
      }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc8_:Sprite = _loc7_.getChildByName(const_8) as Sprite;
